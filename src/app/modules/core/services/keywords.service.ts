  ...
  constructor(private api: ApiService, private groups: GroupManagerService) {
    this.api
      ...
      .then(keywords => {
        ...
        ace.define(
          'ace/mode/mcbasic_highlight_rules',
          [
            'require',
            'exports',
            'module',
                ...
                var e = this.createKeywordMapper(
                  {
                    'keyword.control.asp':
                      keywords +
                      '|common|shared|try|catch|long|double|sys|din|dout|Program|TargetPoint|If|Then|Else|ElseIf|End|While|Wend|For|To|Each|Case|Select|Return|Continue|Do|Until|Loop|Next|With|Exit|Function|Property|Type|Enum|Sub|IIf',
                    'storage.type.asp':
