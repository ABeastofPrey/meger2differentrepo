...
describe('ProgramSettingsComponent', () => {
    ...
    const fakeService = jasmine.createSpyObj('ActivationService', ['getMachineId', 'getKey', 'setKey']);
    let getMachineIdSpy = fakeService.getMachineId.and.returnValue(Promise.resolve(Right(fakeId)));
