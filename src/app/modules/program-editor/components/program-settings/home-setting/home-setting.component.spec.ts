...
describe('HomeSettingComponent', () => {
    ...
    const homeSettingService = jasmine.createSpyObj('', [
        'getHomePostion', 'getHomeOrder', 'updateHomePostion', 'clearHomePosition',
        'updateHomeOrder', 'readCurrentPosition', 'getPositionMax', 'getPositionMin'
    ]);
    ...
    homeSettingService.readCurrentPosition.and.returnValue(Right(fakePositionList));
    ...
    it('should call readCurrentPosition failed', async(() => {
        ...
        fixture.whenStable().then(() => {
            ...
            homeSettingService.readCurrentPosition.and.returnValue(Right('successfully'));
        });
    }));
    ...
    it('should update position failed when enter valid number but not equals to previous input with the same index and over limits',
    async(() => {
        homeSettingService.updateHomePostion.calls.reset();
        homeSettingService.updateHomePostion.and.returnValue(Right());
        fixture.detectChanges();
    ...
    it('should update position failed when enter valid number but not equals to previous input with other index and over limits',
    async(() => {
        homeSettingService.updateHomePostion.calls.reset();
        homeSettingService.updateHomePostion.and.returnValue(Right());
        fixture.detectChanges();
