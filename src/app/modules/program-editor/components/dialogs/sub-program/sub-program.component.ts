...
export class SubProgramComponent implements OnInit {
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<SubProgramComponent>,
    ...
    public subName: FormControl = new FormControl('', [Validators.required, this.validFirstLetter()]);
    ...
    public changeInput(e: any): void {
        ...
        const subName: string = validName.slice(0, 32);
        this.subName.patchValue(subName);
        this.subName.markAsTouched();
    }

    public change(value: string): void {
        this.subName.patchValue(value);
        this.subName.markAsTouched();
    }
    ...
    public insert(): void {
        ...
        if (this.dataSource.length > 0) {
            cmd += `sub ${this.subName.value.toLowerCase()}(${cmdPara.slice(0, cmdPara.length - 1)})\n    'Your code here...\n\nend sub`;
        } else {
            cmd += `sub ${this.subName.value.toLowerCase()}\n    'Your code here...\n\nend sub`;
        }
