...
import { TraceTriggerComponent } from './trace-trigger.component';
...
describe('TraceTriggerComponent', () => {
    let component: TraceTriggerComponent;
    let fixture: ComponentFixture<TraceTriggerComponent>;
    let service: TraceService;

    beforeEach(async(() => {
        TestBed.configureTestingModule({
            declarations: [TraceTriggerComponent],
            providers: [
    ...
    beforeEach(() => {
        fixture = TestBed.createComponent(TraceTriggerComponent);
    ...
    it('should finded with max axis 4 in firstSelectedItemAxis ', () => {
        ...
        service.getTodoDoneList('TRIGGER', 'AllInput', selectedTraceName).subscribe(res => {
