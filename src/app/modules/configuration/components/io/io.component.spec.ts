...
describe('IoComponent', () => {
  ...
  beforeEach(async(() => {
    ...
    TestBed.configureTestingModule({
      ...
      providers: [IoService, { provide: LoginService, useValue: spyLoginObj }, { provide: WebsocketService, useValue: spyObj }],
  ...
  it('should create', async(() => {
    ...
    expect(component.ioOptions[0].key).toEqual('All Inputs', 'the first one is all inputs');
    expect(component.ioOptions[1].key).toEqual('All Outputs', 'the second one is all outputs');

    expect(component.radioButtonOptions.length).toBe(3, 'there are three io value format options');
    expect(component.radioButtonOptions[0].key).toEqual('bit', 'the first one is all inputs');
    expect(component.radioButtonOptions[1].key).toEqual('byte', 'the second one is all outputs');
  ...
  it('the io option should be one input, one output for the dropdown list', () => {
    ...
    expect(component.leftSelected.key).toBe('All Inputs', 'all inputs on the left table');
    expect(component.rightSelected.key).toBe('All Outputs', 'all outputs on the right table');
  ...
  it('the io format option should be bit as default', () => {
    ...
    expect(component.leftRadioOptions.key).toBe('bit', 'the value format is bit on the left table');
    expect(component.rightRadioOptions.key).toBe('bit', 'the value format is bit on the right table');
  ...
  it('the io value can be changed in the left table if the option is output', () => {
    expect(component).toBeTruthy();
    component.leftSelected = { key: IoOptions.AllOutputs, value: 'All Outputs' };
  ...
  it('the io value can be changed in the right table if the option is output', () => {
    expect(component).toBeTruthy();
    component.rightSelected = { key: IoOptions.AllOutputs, value: 'All Outputs' };
