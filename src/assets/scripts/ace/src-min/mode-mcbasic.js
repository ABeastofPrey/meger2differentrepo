...
define('ace/mode/mcbasic_highlight_rules',(e, t, n) => {
  ...
  const s = function() {
    const e = this.createKeywordMapper({
      'keyword.control.asp':  MC_KEYWORDS + '|as|group|common|shared|try|catch|long|double|string|sys|location|generic|joint|din|dout|Program|TargetPoint|If|Then|Else|ElseIf|End|While|Wend|For|To|Each|Case|Select|Return|Continue|Do|Until|Loop|Next|With|Exit|Function|Property|Type|Enum|Sub|IIf',
      'lib.funcs': LIB_FUNCS,
