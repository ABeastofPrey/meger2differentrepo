    ...
    const e = this.createKeywordMapper(
      {
        'keyword.control.asp':
          MC_KEYWORDS +
          '|as|group|common|shared|try|catch|long|double|string|sys|location|generic|joint|din|dout|Program|TargetPoint|If|Then|Else|ElseIf|End|terminate|While|Wend|For|To|Each|Case|Select|Return|Continue|Do|Until|Loop|Next|With|Exit|Function|Property|Type|Enum|Sub|IIf',
        'lib.funcs': LIB_FUNCS,
        'storage.type.asp':
        ...
        'constant.language.asp':
          'Empty|False|Nothing|Null|True|' + MC_CONSTANTS,
        'support.class.asp':
