  ...
  for (
    ...
    do {
      ...
      var c = 0 == h[1].length ? 0 : parseInt(h[1], 10),
        n = 0 == k[1].length ? 0 : parseInt(k[1], 10),
        c =
          goog.string.compareElements_(c, n) ||
          goog.string.compareElements_(0 == h[2].length, 0 == k[2].length) ||
...
goog.style.installStyles = function(a, b) {
  return goog.style.installSafeStyleSheet(
    goog.html.legacyconversions.safeStyleSheetFromString(a),
    b
  );
};
goog.style.installSafeStyleSheet = function(a, b) {
  ...
  goog.userAgent.IE && e.createStyleSheet
    ? ((d = e.createStyleSheet()), goog.style.setSafeStyleSheet(d, a))
    : ((e = c.getElementsByTagNameAndClass('HEAD')[0]),
      e ||
...
goog.style.setStyles = function(a, b) {
  goog.style.setSafeStyleSheet(
    a,
    goog.html.legacyconversions.safeStyleSheetFromString(b)
  );
};
...
goog.ui.PaletteRenderer.prototype.createTable = function(a, b) {
  var c = b.createDom(
    ...
    b.createDom('TBODY', this.getCssClass() + '-body', a)
  );
  c.cellSpacing = '0';
  c.cellPadding = '0';
  return c;
...
goog.ui.Palette.prototype.performActionInternal = function(a) {
  ...
  return b
    ? (a && this.shouldSelectHighlightedItem_(a) && this.setSelectedItem(b),
...
goog.ui.Palette.prototype.shouldSelectHighlightedItem_ = function(a) {
  return this.getSelectedItem()
    ? 'mouseup' != a.type
      ? !0
      : !!this.getRenderer().getContainingItem(this, a.target)
    : !0;
};
...
Blockly.onMouseUp_ = function(a) {
  ...
  a.dragMode_ != Blockly.DRAG_NONE &&
    ...
    (a.dragMode_ = Blockly.DRAG_NONE),
    Blockly.Touch.onTouchUpWrapper_ &&
...
Blockly.onMouseMove_ = function(a) {
  ...
  if (b.dragMode_ != Blockly.DRAG_NONE) {
    ...
    Math.sqrt(c * c + d * d) > Blockly.DRAG_RADIUS &&
      (Blockly.longStop_(), (b.dragMode_ = Blockly.DRAG_FREE));
    a.stopPropagation();
    a.preventDefault();
  }
};
...
Blockly.Touch.isMouseOrTouchEvent = function(a) {
  return (
    goog.string.startsWith(a.type, 'touch') ||
    goog.string.startsWith(a.type, 'mouse')
  );
};
...
Blockly.Workspace.prototype.renameVariable = function(a, b) {
  ...
  c == d || (-1 != c && -1 == d)
    ? (this.variableList[c] = b)
    : -1 != c && -1 != d
    ? ((this.variableList[d] = b), this.variableList.splice(c, 1))
...
Blockly.Workspace.prototype.deleteVariable = function(a) {
  function b() {
    Blockly.Events.setGroup(!0);
    for (var a = 0; a < d.length; a++) d[a].dispose(!0, !1);
    Blockly.Events.setGroup(!1);
    g.variableList.splice(c, 1);
  }
  var c = this.variableIndexOf(a);
  if (-1 != c) {
    for (var d = this.getVariableUses(a), e = 0, f; (f = d[e]); e++)
      if (
        'procedures_defnoreturn' == f.type ||
        'procedures_defreturn' == f.type
      ) {
        e = f.getFieldValue('NAME');
        Blockly.alert(
          Blockly.Msg.CANNOT_DELETE_VARIABLE_PROCEDURE.replace('%1', a).replace(
            '%2',
            e
          )
        );
...
Blockly.Bubble.prototype.layoutBubble_ = function() {
  ...
  this.workspace_.RTL
    ? d - c.viewLeft - a - this.width_ < Blockly.Scrollbar.scrollbarThickness
      ? (a =
          d - c.viewLeft - this.width_ - Blockly.Scrollbar.scrollbarThickness)
      : d - c.viewLeft - a > c.viewWidth && (a = d - c.viewLeft - c.viewWidth)
    : d + a < c.viewLeft
    ? (a = c.viewLeft - d)
...
Blockly.Bubble.prototype.positionBubble_ = function() {
  ...
  this.bubbleGroup_.setAttribute(
    'transform',
    'translate(' + a + ',' + (this.relativeTop_ + this.anchorXY_.y) + ')'
  );
};
...
Blockly.Icon.prototype.computeIconLocation = function() {
  var a = this.block_.getRelativeToSurfaceXY(),
    ...
    a = new goog.math.Coordinate(
      a.x + b.x + this.SIZE / 2,
      a.y + b.y + this.SIZE / 2
    );
  goog.math.Coordinate.equals(this.getIconLocation(), a) ||
...
Blockly.Comment.prototype.setText = function(a) {
  this.text_ != a &&
    (Blockly.Events.fire(
      new Blockly.Events.Change(this.block_, 'comment', null, this.text_, a)
    ),
    (this.text_ = a));
...
Blockly.Connection.prototype.connect_ = function(a) {
  ...
  var n;
  Blockly.Events.isEnabled() && (n = new Blockly.Events.Move(d));
...
Blockly.Connection.prototype.isConnectionAllowed = function(a) {
  ...
  return (a.type == Blockly.INPUT_VALUE &&
    a.isConnected() &&
    ...
    -1 != Blockly.draggingConnections_.indexOf(a)
    ? !1
    : !0;
};
...
Blockly.Connection.prototype.disconnect = function() {
  ...
  var b, c;
  this.isSuperior()
    ? ((b = this.sourceBlock_), (c = a.getSourceBlock()), (a = this))
...
Blockly.Field.prototype.init = function() {
  this.fieldGroup_ ||
    ...
    (this.borderRect_ = Blockly.utils.createSvgElement(
      'rect',
      { rx: 4, ry: 4, x: -Blockly.BlockSvg.SEP_SPACE_X / 2, y: 0, height: 16 },
      this.fieldGroup_,
...
Blockly.Field.prototype.updateEditable = function() {
  ...
  this.EDITABLE &&
    ...
    (this.sourceBlock_.isEditable()
      ? (Blockly.utils.addClass(a, 'blocklyEditableText'),
        Blockly.utils.removeClass(a, 'blocklyNonEditableText'),
        (this.fieldGroup_.style.cursor = this.CURSOR))
      : (Blockly.utils.addClass(a, 'blocklyNonEditableText'),
...
Blockly.Field.prototype.render_ = function() {
  if (this.visible_) {
    ...
    a = Blockly.Field.getCachedWidth(this.textElement_);
    this.borderRect_ &&
...
Blockly.Field.getCachedWidth = function(a) {
  var b = a.textContent + '\n' + a.className.baseVal;
  if (Blockly.Field.cacheWidths_ && Blockly.Field.cacheWidths_[b])
    var c = Blockly.Field.cacheWidths_[b];
  else {
    try {
      c = a.getComputedTextLength();
    } catch (d) {
      c = 8 * a.textContent.length;
    }
...
Blockly.Field.prototype.getScaledBBox_ = function() {
  ...
  return new goog.math.Size(
    a.width * this.sourceBlock_.workspace.scale,
    a.height * this.sourceBlock_.workspace.scale
  );
};
  ...
  if (null !== a) {
    ...
    b != a &&
      (this.sourceBlock_ &&
        ...
        Blockly.Events.fire(
          new Blockly.Events.Change(this.sourceBlock_, 'field', this.name, b, a)
        ),
      this.setText(a));
  }
};
...
Blockly.Tooltip.show_ = function() {
  ...
  if (Blockly.Tooltip.DIV) {
    ...
    for (var a = Blockly.Tooltip.element_.tooltip; goog.isFunction(a); )
      a = a();
    for (
      var a = Blockly.utils.wrap(a, Blockly.Tooltip.LIMIT),
        a = a.split('\n'),
        b = 0;
      b < a.length;
      b++
    ...
    d + Blockly.Tooltip.DIV.offsetHeight > b.height + window.scrollY &&
      (d -= Blockly.Tooltip.DIV.offsetHeight + 2 * Blockly.Tooltip.OFFSET_Y);
    a
      ? (c = Math.max(Blockly.Tooltip.MARGINS - window.scrollX, c))
      : c + Blockly.Tooltip.DIV.offsetWidth >
          b.width + window.scrollX - 2 * Blockly.Tooltip.MARGINS &&
        (c =
          b.width -
...
Blockly.FieldLabel.prototype.init = function() {
  this.textElement_ ||
    ...
    this.class_ && Blockly.utils.addClass(this.textElement_, this.class_),
...
Blockly.ConnectionDB.prototype.getNeighbours = function(a, b) {
  ...
  for (
    var d = this, e = a.x_, f = a.y_, g = 0, h = d.length - 2, k = h;
    g < k;
...
Blockly.Scrollbar.prototype.setPosition = function(a, b) {
  this.position_.x = a;
  this.position_.y = b;
  this.outerSvg_.style.transform =
    'translate(' +
...
Blockly.Scrollbar.prototype.resizeViewVertical = function(a) {
  ...
  this.setPosition(b, a.absoluteTop + 0.5);
...
Blockly.Scrollbar.prototype.onMouseDownBar_ = function(a) {
  ...
  if (Blockly.utils.isRightButton(a)) a.stopPropagation();
    ...
    var b = Blockly.utils.mouseToSvg(
      ...
      c = Blockly.utils.getInjectionDivXY_(this.svgHandle_),
...
Blockly.Trashcan.prototype.createDom = function() {
  ...
  var a = String(Math.random()).substring(2),
    b = Blockly.utils.createSvgElement(
      'clipPath',
    ...
    (this.workspace_.RTL
      ? ((this.left_ =
        ...
        a.toolboxPosition == Blockly.TOOLBOX_AT_LEFT &&
          ((this.left_ += a.flyoutWidth),
          this.workspace_.toolbox_ && (this.left_ += a.absoluteLeft)))
      : ((this.left_ =
          a.viewWidth +
          a.absoluteLeft -
          this.WIDTH_ -
          this.MARGIN_SIDE_ -
          Blockly.Scrollbar.scrollbarThickness),
        a.toolboxPosition == Blockly.TOOLBOX_AT_RIGHT &&
          (this.left_ -= a.flyoutWidth)),
    (this.top_ =
      a.viewHeight +
      a.absoluteTop -
...
Blockly.Trashcan.prototype.getClientRect = function() {
  ...
  return new goog.math.Rect(
    a.left + this.SPRITE_LEFT_ - this.MARGIN_HOTSPOT_,
    a.top + this.SPRITE_TOP_ - this.MARGIN_HOTSPOT_,
...
Blockly.utils.getRelativeXY = function(a) {
  ...
  (a = a.getAttribute('style')) &&
    ...
    ((c = a.match(Blockly.utils.getRelativeXY.XY_2D_REGEX_)) ||
      (c = a.match(Blockly.utils.getRelativeXY.XY_3D_REGEX_)),
...
Blockly.utils.getScale_ = function(a) {
  ...
  (a = a.getAttribute('transform')) &&
    (a = a.match(Blockly.utils.getScale_.REGEXP_)) &&
    a[0] &&
    (b = parseFloat(a[0]));
  return b;
};
...
Blockly.utils.createSvgElement = function(a, b, c, d) {
...
Blockly.utils.commonWordPrefix = function(a, b) {
  ...
  for (
    var c = 0, d = b || Blockly.utils.shortestStringLength(a), e = 0;
    e < d;
    e++
  ) {
...
Blockly.utils.tokenizeInterpolation = function(a) {
  ...
  for (var e = null, f = 0; f < c.length; f++) {
    ...
    0 == d
      ? '%' == g
        ? ((g = a.join('')) && b.push(g), (a.length = 0), (d = 1))
        : a.push(g)
      : 1 == d
      ? '%' == g
        ? (a.push(g), (d = 0))
        : '0' <= g && '9' >= g
        ? ((d = 2), (e = g), (g = a.join('')) && b.push(g), (a.length = 0))
        : '{' == g
        ? (d = 3)
        : (a.push('%', g), (d = 0))
      : 2 == d
      ...
      : 3 == d &&
        ('' == g
          ...
          ? a.push(g)
          : ((d = a.join('')),
            /[a-zA-Z][a-zA-Z0-9_]*/.test(d)
              ? ((g = d.toUpperCase()),
                (g = goog.string.startsWith(g, 'BKY_')
                  ? g.substring(4)
                  : null) && g in Blockly.Msg
                  ? ((d = Blockly.utils.tokenizeInterpolation(Blockly.Msg[g])),
                    (b = b.concat(d)))
                  : b.push('%{' + d + '}'))
              : b.push('%{' + d + '}'),
            (d = a.length = 0)));
  ...
  for (f = a.length = 0; f < b.length; ++f)
    'string' == typeof b[f]
      ? a.push(b[f])
      : ((g = a.join('')) && c.push(g), (a.length = 0), c.push(b[f]));
  (g = a.join('')) && c.push(g);
  a.length = 0;
  return c;
};
...
Blockly.utils.wrapLine_ = function(a, b) {
  ...
  do {
    e = d;
    f = a;
    for (var h = [], k = c.length / g, n = 1, d = 0; d < c.length - 1; d++)
...
Blockly.utils.wrapMutate_ = function(a, b, c) {
  for (
    var d = Blockly.utils.wrapScore_(a, b, c), e, f = 0;
    f < b.length - 1;
    f++
  )
    if (b[f] != b[f + 1]) {
...
Blockly.workspaceDragSurfaceSvg.prototype.translateSurface = function(a, b) {
  ...
  this.SVG_.setAttribute(
    'style',
    'transform: translate3d(' + a + 'px, ' + b + 'px, 0px); display: block;'
  );
};
...
Blockly.workspaceDragSurfaceSvg.prototype.clearAndHide = function(a) {
  ...
  if (
    !(
      b &&
      c &&
      Blockly.utils.hasClass(b, 'blocklyBlockCanvas') &&
      Blockly.utils.hasClass(c, 'blocklyBubbleCanvas')
    )
  )
    throw "Couldn't clear and hide the drag surface.  A node was missing.";
  null != this.previousSibling_
    ? Blockly.utils.insertAfter_(b, this.previousSibling_)
    : a.insertBefore(b, a.firstChild);
  Blockly.utils.insertAfter_(c, b);
  this.SVG_.style.display = 'none';
  goog.asserts.assert(
    0 == this.SVG_.childNodes.length,
...
Blockly.Xml.blockToDom = function(a, b) {
  ...
  for (d = 0; (e = a.inputList[d]); d++) {
    var k;
    g = !0;
    e.type != Blockly.DUMMY_INPUT &&
      ((h = e.connection.targetBlock()),
      e.type == Blockly.INPUT_VALUE
        ? (k = goog.dom.createDom('value'))
        : e.type == Blockly.NEXT_STATEMENT &&
          (k = goog.dom.createDom('statement')),
      (f = e.connection.getShadowDom()),
      !f || (h && h.isShadow()) || k.appendChild(Blockly.Xml.cloneShadow_(f)),
      h && (k.appendChild(Blockly.Xml.blockToDom(h, b)), (g = !1)),
...
Blockly.Xml.domToBlockHeadless_ = function(a, b) {
  ...
  for (
    var e = a.getAttribute('id'), c = b.newBlock(d, e), f = null, e = 0, g;
    (g = a.childNodes[e]);
    e++
  )
    if (3 != g.nodeType) {
      for (var h = (f = null), k = 0, n; (n = g.childNodes[k]); k++)
        1 == n.nodeType &&
          ('block' == n.nodeName.toLowerCase()
            ? (f = n)
            : 'shadow' == n.nodeName.toLowerCase() && (h = n));
      !f && h && (f = h);
...
Blockly.ZoomControls.prototype.createDom = function() {
  ...
  var b = String(Math.random()).substring(2),
    c = Blockly.utils.createSvgElement(
      'clipPath',
  ...
  d.setAttributeNS(
    'http://www.w3.org/1999/xlink',
    'xlink:href',
    a.options.pathToMedia + Blockly.SPRITE.url
  );
  c = Blockly.utils.createSvgElement(
    'clipPath',
  ...
  var e = Blockly.utils.createSvgElement(
    'image',
    {
      width: Blockly.SPRITE.width,
      height: Blockly.SPRITE.height,
...
Blockly.WorkspaceSvg.prototype.getSvgXY = function(a) {
  var b = 0,
    ...
    d = 1;
  if (
    goog.dom.contains(this.getCanvas(), a) ||
    goog.dom.contains(this.getBubbleCanvas(), a)
  )
    d = this.scale;
  do {
    var e = Blockly.utils.getRelativeXY(a);
...
Blockly.WorkspaceSvg.prototype.createDom = function(a) {
  ...
  this.options.zoomOptions &&
    this.options.zoomOptions.controls &&
    (a = this.addZoomControls_(a));
  if (!this.isFlyout) {
    Blockly.bindEventWithChecks_(
      this.svgGroup_,
      'mousedown',
...
Blockly.WorkspaceSvg.prototype.resizeContents = function() {
  this.resizesEnabled_ &&
    this.rendered &&
    (this.scrollbar && this.scrollbar.resize(), this.updateInverseScreenCTM());
};
...
Blockly.WorkspaceSvg.prototype.updateScreenCalculationsIfScrolled = function() {
  ...
  goog.math.Coordinate.equals(this.lastRecordedPageScroll_, a) ||
...
Blockly.WorkspaceSvg.prototype.highlightBlock = function(a, b) {
  ...
  if ((d = a ? this.getBlockById(a) : null))
    (c = void 0 === b || b)
      ...
      : goog.array.remove(this.highlightedBlocks_, d),
      d.setHighlighted(c);
};
    ...
    try {
      ...
      if (!isNaN(c) && !isNaN(d)) {
        ...
        do {
          ...
          if (!a)
            for (var k = b.getConnections_(!1), f = 0, n; (n = k[f]); f++)
              if (
                n.closest(Blockly.SNAP_RADIUS, new goog.math.Coordinate(c, d))
                  .connection
              ) {
                a = !0;
                break;
  ...
  if (!this.options.readOnly && !this.isFlyout) {
    ...
    if (this.options.collapse) {
      for (var h = (g = !1), k = 0; k < e.length; k++)
        for (var n = e[k]; n; )
          n.isCollapsed() ? (g = !0) : (h = !0), (n = n.getNextBlock());
      var p = function(a) {
    ...
    g = {
      text:
        1 == l.length
          ...
          : Blockly.Msg.DELETE_X_BLOCKS.replace('%1', String(l.length)),
      enabled: 0 < l.length,
      callback: function() {
        2 > l.length
          ? c()
          : Blockly.confirm(
              Blockly.Msg.DELETE_ALL_BLOCKS.replace('%1', l.length),
              function(a) {
                a && c();
              }
            );
...
Blockly.WorkspaceSvg.prototype.playAudio = function(a, b) {
  ...
  if (c) {
    var d = new Date();
    d - this.lastSound_ < Blockly.SOUND_LIMIT ||
      ((this.lastSound_ = d),
      (c =
...
Blockly.WorkspaceSvg.prototype.zoom = function(a, b, c) {
  ...
  d = Math.pow(d, c);
  c = this.scale * d;
  c > this.options.zoomOptions.maxScale
    ? (d = this.options.zoomOptions.maxScale / this.scale)
    : c < this.options.zoomOptions.minScale &&
      (d = this.options.zoomOptions.minScale / this.scale);
  this.scale != c &&
    (this.scrollbar &&
      ((a = f
        .getCTM()
        .translate(a * (1 - d), b * (1 - d))
        .scale(d)),
...
Blockly.WorkspaceSvg.prototype.updateGridPattern_ = function() {
  if (this.options.gridPattern) {
    ...
    var a = Math.floor(this.options.gridOptions.spacing / 2) + 0.5,
      ...
      c = c * this.scale;
    d &&
      (d.setAttribute('stroke-width', this.scale),
      d.setAttribute('x1', b),
      d.setAttribute('y1', a),
      d.setAttribute('x2', c),
      d.setAttribute('y2', a));
    e &&
      (e.setAttribute('stroke-width', this.scale),
      e.setAttribute('x1', a),
      e.setAttribute('y1', b),
      e.setAttribute('x2', a),
      e.setAttribute('y2', c));
...
Blockly.WorkspaceSvg.getTopLevelWorkspaceMetrics_ = function() {
  ...
  var b = Blockly.Flyout.prototype.CORNER_RADIUS - 1,
    ...
    k = e.y * this.scale;
  this.scrollbar
    ? ((b = Math.min(h - c / 2, h + f - c)),
      (c = Math.max(h + f + c / 2, h + c)),
      (f = Math.min(k - d / 2, k + g - d)),
      (d = Math.max(k + g + d / 2, k + d)))
    : ((b = e.x), (c = b + e.width), (f = e.y), (d = f + e.height));
  e = 0;
  this.toolbox_ &&
    this.toolboxPosition == Blockly.TOOLBOX_AT_LEFT &&
    (e = this.toolbox_.getWidth());
  g = 0;
  this.toolbox_ &&
    this.toolboxPosition == Blockly.TOOLBOX_AT_TOP &&
    (g = this.toolbox_.getHeight());
  return {
    viewHeight: a.height,
    viewWidth: a.width,
    contentHeight: d - f,
...
Blockly.WorkspaceSvg.setTopLevelWorkspaceMetrics_ = function(a) {
  ...
  this.options.gridPattern &&
    ...
    (goog.userAgent.IE || goog.userAgent.EDGE) && this.updateGridPattern_());
};
...
Blockly.WorkspaceSvg.prototype.getButtonCallback = function(a) {
  return this.flyoutButtonCallbacks_[a];
};
    ...
    if (
      ...
      this.workspace_.flyout_
        ? ((a = 2 * this.workspace_.flyout_.CORNER_RADIUS),
          (b = this.workspace_.flyout_.width_ + a))
        : (b = a = 16);
      this.block_.RTL && (b = -b);
...
Blockly.Warning.textToDom_ = function(a) {
  var b = Blockly.utils.createSvgElement(
    'text',
...
Blockly.Block.prototype.renameVar = function(a, b) {
  for (var c = 0, d; (d = this.inputList[c]); c++)
    for (var e = 0, f; (f = d.fieldRow[e]); e++)
      f instanceof Blockly.FieldVariable &&
        Blockly.Names.equals(a, f.getValue()) &&
        f.setValue(b);
};
...
Blockly.Block.prototype.setInputsInline = function(a) {
  this.inputsInline != a &&
    (Blockly.Events.fire(
      new Blockly.Events.Change(this, 'inline', null, this.inputsInline, a)
    ),
    (this.inputsInline = a));
};
...
Blockly.Block.prototype.setDisabled = function(a) {
  this.disabled != a &&
    (Blockly.Events.fire(
      new Blockly.Events.Change(this, 'disabled', null, this.disabled, a)
    ),
    (this.disabled = a));
};
...
Blockly.Block.prototype.setCollapsed = function(a) {
  this.collapsed_ != a &&
    (Blockly.Events.fire(
      new Blockly.Events.Change(this, 'collapsed', null, this.collapsed_, a)
    ),
    (this.collapsed_ = a));
};
...
Blockly.Block.prototype.interpolate_ = function(a, b, c) {
  ...
  a.length &&
    ('string' == typeof a[a.length - 1] ||
      goog.string.startsWith(a[a.length - 1].type, 'field_')) &&
...
Blockly.Block.prototype.setCommentText = function(a) {
  this.comment != a &&
    (Blockly.Events.fire(
      new Blockly.Events.Change(this, 'comment', null, this.comment, a || '')
    ),
    (this.comment = a));
};
...
Blockly.ContextMenu.show = function(a, b, c) {
  ...
  if (b.length) {
    ...
    for (var e = 0, f; (f = b[e]); e++) {
      ...
      f.enabled &&
        (goog.events.listen(g, goog.ui.Component.EventType.ACTION, f.callback),
    ...
    var h = d.getElement();
    Blockly.utils.addClass(h, 'blocklyContextMenu');
    Blockly.bindEventWithChecks_(h, 'contextmenu', null, Blockly.utils.noEvent);
    f = goog.style.getSize(h);
    var g = a.clientX + e.x,
      k = a.clientY + e.y;
    a.clientY + f.height >= b.height && (k -= f.height);
    c
      ? f.width >= a.clientX && (g += f.width)
      : a.clientX + f.width >= b.width && (g -= f.width);
...
Blockly.ContextMenu.callbackFactory = function(a, b) {
  return function() {
    ...
    Blockly.Events.isEnabled() &&
      !c.isShadow() &&
      Blockly.Events.fire(new Blockly.Events.Create(c));
    c.select();
  };
};
...
Blockly.BlockSvg = function(a, b, c) {
  ...
  this.svgPathDark_ = Blockly.utils.createSvgElement(
    'path',
  ...
  this.svgPathLight_ = Blockly.utils.createSvgElement(
    'path',
...
Blockly.BlockSvg.prototype.getBoundingRectangle = function() {
  var a = this.getRelativeToSurfaceXY(this),
    ...
    d;
  this.RTL
    ? ((d = new goog.math.Coordinate(a.x - (c.width - b), a.y)),
...
Blockly.BlockSvg.prototype.onMouseDown_ = function(a) {
  if (!this.workspace.options.readOnly)
    if (this.isInFlyout)
      'touchstart' == a.type &&
        Blockly.utils.isRightButton(a) &&
        (Blockly.Flyout.blockRightClick_(a, this),
        a.stopPropagation(),
        a.preventDefault());
    else {
      ...
      if (Blockly.utils.isRightButton(a))
        this.showContextMenu_(a), Blockly.Touch.clearTouchIdentifier();
        ...
        Blockly.BlockSvg.onMouseUpWrapper_ = Blockly.bindEventWithChecks_(
          document,
          'mouseup',
          this,
          this.onMouseUp_
...
Blockly.BlockSvg.prototype.onMouseUp_ = function(a) {
  ...
  Blockly.dragMode_ == Blockly.DRAG_FREE ||
    Blockly.WidgetDiv.isVisible() ||
    Blockly.Events.fire(new Blockly.Events.Ui(this, 'click', void 0, void 0));
  Blockly.terminateDrag_();
    ...
    ? (Blockly.localConnection_.connect(Blockly.highlightedConnection_),
      this.rendered &&
        (Blockly.localConnection_.isSuperior()
          ...
          .getSourceBlock()
          .connectionUiEffect(),
      this.workspace.trashcan && this.workspace.trashcan.close())
    : !this.getParent() &&
      Blockly.selected.isDeletable() &&
      this.workspace.isDeleteArea(a) &&
      ((a = this.workspace.trashcan) && goog.Timer.callOnce(a.close, 100, a),
...
Blockly.BlockSvg.prototype.onMouseMove_ = function(a) {
  if (
    ...
    if (
      Blockly.dragMode_ == Blockly.DRAG_STICKY &&
      goog.math.Coordinate.distance(b, c) * this.workspace.scale >
        Blockly.DRAG_RADIUS
    ) {
      Blockly.dragMode_ = Blockly.DRAG_FREE;
      Blockly.longStop_();
    ...
    if (Blockly.dragMode_ == Blockly.DRAG_FREE) {
      ...
      d = this.getSvgRoot();
      this.useDragSurface_
        ? this.workspace.blockDragSurface_.translateSurface(c.x, c.y)
        : ((d.translate_ = 'translate(' + c.x + ',' + c.y + ')'),
      ...
      (c = this.lastConnectionInStack_()) &&
        c != this.nextConnection &&
        d.push(c);
      for (
        var e = null, f = null, g = Blockly.SNAP_RADIUS, c = 0;
        c < d.length;
        c++
      ) {
        var h = d[c],
          k = h.closest(g, b);
        k.connection && ((e = k.connection), (f = h), (g = k.radius));
      }
      Blockly.highlightedConnection_ &&
...
Blockly.BlockSvg.prototype.connectionUiEffect = function() {
  ...
  if (!(1 > this.workspace.scale)) {
    var a = this.workspace.getSvgXY(this.svgGroup_);
    this.outputConnection
      ? ((a.x += (this.RTL ? 3 : -3) * this.workspace.scale),
        (a.y += 13 * this.workspace.scale))
      : this.previousConnection &&
        ((a.x += (this.RTL ? -23 : 23) * this.workspace.scale),
        (a.y += 3 * this.workspace.scale));
    a = Blockly.utils.createSvgElement(
      'circle',
      {
        cx: a.x,
        cy: a.y,
...
Blockly.BlockSvg.prototype.updateColour = function() {
  if (!this.disabled) {
    ...
    if (this.isShadow())
      (b = goog.color.lighten(b, 0.6)),
        (a = goog.color.rgbArrayToHex(b)),
        (this.svgPathLight_.style.display = 'none'),
        this.svgPathDark_.setAttribute('fill', a);
    else {
      this.svgPathLight_.style.display = '';
      var c = goog.color.rgbArrayToHex(goog.color.lighten(b, 0.3)),
        b = goog.color.rgbArrayToHex(goog.color.darken(b, 0.2));
...
Blockly.BlockSvg.prototype.setWarningText = function(a, b) {
  ...
  var c = b || '';
  if (c)
    this.setWarningText.pid_[c] &&
      (clearTimeout(this.setWarningText.pid_[c]),
...
Blockly.BlockSvg.prototype.renderCompute_ = function(a) {
  ...
  for (
    var d = 0,
      ...
      h = !1,
      k = void 0,
      n = this.getInputsInline() && !this.isCollapsed(),
      p = 0,
      l;
    (l = b[p]);
    p++
    ...
    if (l.isVisible()) {
      var m;
      n && k && k != Blockly.NEXT_STATEMENT && l.type != Blockly.NEXT_STATEMENT
        ? (m = c[c.length - 1])
        : ((k = l.type),
          (m = []),
          (m.type =
            n && l.type != Blockly.NEXT_STATEMENT
      ...
      n || p != b.length - 1
        ? !n &&
          ...
          b[p + 1] &&
          b[p + 1].type == Blockly.NEXT_STATEMENT &&
          l.renderHeight--
        : l.renderHeight--;
      ...
      m.type != Blockly.BlockSvg.INLINE &&
        (m.type == Blockly.NEXT_STATEMENT
          ? ((g = !0), (e = Math.max(e, l.fieldWidth)))
          : (m.type == Blockly.INPUT_VALUE
              ? (f = !0)
              : m.type == Blockly.DUMMY_INPUT && (h = !0),
...
Blockly.BlockSvg.prototype.renderDrawTop_ = function(a, b, c) {
  this.squareTopLeftCorner_
    ? (a.push('m 0,0'),
      b.push('m 0.5,0.5'),
      this.startHat_ &&
        (a.push(Blockly.BlockSvg.START_HAT_PATH),
        b.push(
          this.RTL
            ? Blockly.BlockSvg.START_HAT_HIGHLIGHT_RTL
            : Blockly.BlockSvg.START_HAT_HIGHLIGHT_LTR
...
Blockly.BlockSvg.prototype.renderDrawRight_ = function(a, b, c, d, e, f) {
  for (var g, h = 0, k, n, p = 0, l; (l = e[p]); p++) {
    ...
    0 == p && (g += this.RTL ? -f : f);
    b.push('M', e.rightEdge - 0.5 + ',' + (h + 0.5));
    if (this.isCollapsed()) {
      var m = l[0];
      k = h;
      ...
      a.push('v', m);
      this.RTL &&
        (b.push('v 3.9 l 7.2,3.4 m -14.5,8.9 l 7.3,3.5'), b.push('v', m - 0.7));
      ...
      for (var q = 0; (m = l[q]); q++)
        (k = h),
          ...
          (g = this.renderFields_(m.fieldRow, g, k)),
          m.type != Blockly.DUMMY_INPUT &&
            (g += m.renderWidth + Blockly.BlockSvg.SEP_SPACE_X),
          m.type == Blockly.INPUT_VALUE &&
            (c.push(
              'M',
              g -
                Blockly.BlockSvg.SEP_SPACE_X +
                ',' +
                (h + Blockly.BlockSvg.INLINE_PADDING_Y)
            ),
            c.push('h', Blockly.BlockSvg.TAB_WIDTH - 2 - m.renderWidth),
            c.push(Blockly.BlockSvg.TAB_PATH_DOWN),
            c.push('v', m.renderHeight + 1 - Blockly.BlockSvg.TAB_HEIGHT),
            c.push('h', m.renderWidth + 2 - Blockly.BlockSvg.TAB_WIDTH),
            c.push('z'),
            this.RTL
              ? (d.push(
                  'M',
                  g -
                    ...
                    m.renderWidth +
                    ',' +
                    (h + Blockly.BlockSvg.INLINE_PADDING_Y + 0.5)
                ),
                d.push(Blockly.BlockSvg.TAB_PATH_DOWN_HIGHLIGHT_RTL),
                d.push('v', m.renderHeight - Blockly.BlockSvg.TAB_HEIGHT + 2.5),
                d.push('h', m.renderWidth - Blockly.BlockSvg.TAB_WIDTH + 2))
              : (d.push(
                  'M',
                  g -
                    Blockly.BlockSvg.SEP_SPACE_X +
                ...
                d.push('v', m.renderHeight + 1),
                d.push('h', Blockly.BlockSvg.TAB_WIDTH - 2 - m.renderWidth),
                d.push(
                  'M',
                  g -
                    m.renderWidth -
            ...
            (k = this.RTL
              ...
              : g +
                ...
                m.renderWidth -
                1),
            (n = h + Blockly.BlockSvg.INLINE_PADDING_Y + 1),
      ...
      l.type == Blockly.INPUT_VALUE
        ? ((m = l[0]),
          (k = h),
          m.align != Blockly.ALIGN_LEFT &&
            ((q =
              e.rightEdge -
              m.fieldWidth -
              Blockly.BlockSvg.TAB_WIDTH -
              2 * Blockly.BlockSvg.SEP_SPACE_X),
            m.align == Blockly.ALIGN_RIGHT
              ? (g += q)
              : m.align == Blockly.ALIGN_CENTRE && (g += q / 2)),
          this.renderFields_(m.fieldRow, g, k),
          ...
          this.RTL
            ...
            : (b.push(
                'M',
                e.rightEdge - 5 + ',' + (h + Blockly.BlockSvg.TAB_HEIGHT - 0.7)
              ),
              b.push('l', 0.46 * Blockly.BlockSvg.TAB_WIDTH + ',-2.1')),
          (k = this.RTL ? -e.rightEdge - 1 : e.rightEdge + 1),
          m.connection.setOffsetInBlock(k, h),
          m.connection.isConnected() &&
            (this.width = Math.max(
              this.width,
              e.rightEdge +
                m.connection.targetBlock().getHeightWidth().width -
                Blockly.BlockSvg.TAB_WIDTH +
                1
            )))
        ...
        : l.type == Blockly.NEXT_STATEMENT &&
          ...
          this.RTL
            ? (b.push(
                ...
                g -
                  ...
                  Blockly.BlockSvg.DISTANCE_45_OUTSIDE +
                  ',' +
                  (h + Blockly.BlockSvg.DISTANCE_45_OUTSIDE)
              ),
            ...
            : (b.push(
                ...
                g -
                  ...
                  Blockly.BlockSvg.DISTANCE_45_OUTSIDE +
                  ',' +
                  (h + l.height - Blockly.BlockSvg.DISTANCE_45_OUTSIDE)
              ),
              b.push(Blockly.BlockSvg.INNER_BOTTOM_LEFT_CORNER_HIGHLIGHT_LTR)),
          b.push('H', e.rightEdge - 0.5),
          (k = this.RTL ? -g : g + 1),
          m.connection.setOffsetInBlock(k, h + 1),
          m.connection.isConnected() &&
            (this.width = Math.max(
              this.width,
              e.statementEdge +
          ...
          p == e.length - 1 || e[p + 1].type == Blockly.NEXT_STATEMENT) &&
          (a.push('v', Blockly.BlockSvg.SEP_SPACE_Y),
          this.RTL && b.push('v', Blockly.BlockSvg.SEP_SPACE_Y - 1),
          (h += Blockly.BlockSvg.SEP_SPACE_Y));
    h += l.height;
  ...
  e.length ||
    ((h = Blockly.BlockSvg.MIN_BLOCK_Y),
    a.push('V', h),
...
Blockly.BlockSvg.prototype.renderDrawBottom_ = function(a, b, c) {
  ...
  this.squareBottomLeftCorner_
    ? (a.push('H 0'), this.RTL || b.push('M', '0.5,' + (c - 0.5)))
      ...
      this.RTL ||
        ...
        b.push(
          ...
          Blockly.BlockSvg.CORNER_RADIUS -
            ...
            (Blockly.BlockSvg.CORNER_RADIUS - 0.5) +
            ' 0 0,1 0.5,' +
            (c - Blockly.BlockSvg.CORNER_RADIUS)
        )));
};
...
Blockly.Events.filter = function(a, b) {
  ...
  for (var d = 0, e; (e = c[d]); d++)
    for (var f = d + 1, g; (g = c[f]); f++)
      e.type == g.type &&
        e.blockId == g.blockId &&
        e.workspaceId == g.workspaceId &&
        (e.type == Blockly.Events.MOVE
          ? ((e.newParentId = g.newParentId),
          ...
          : e.type == Blockly.Events.CHANGE &&
            e.element == g.element &&
            e.name == g.name
          ? ((e.newValue = g.newValue), c.splice(f, 1), f--)
          : e.type != Blockly.Events.UI ||
            'click' != g.element ||
            ('commentOpen' != e.element &&
              'mutatorOpen' != e.element &&
              'warningOpen' != e.element) ||
            ((e.newValue = g.newValue), c.splice(f, 1), f--));
  ...
  if (a)
    ...
    for (var c; (c = this.ids[a]); a++) {
      ...
      d
        ? d.dispose(!1, !1)
        : c == this.blockId &&
          console.warn("Can't uncreate non-existant block: " + c);
    }
  }
};
  ...
  if (a) {
    ...
    for (var c; (c = this.ids[a]); a++) {
      ...
      d
        ? d.dispose(!1, !1)
        : c == this.blockId &&
          console.warn("Can't delete non-existant block: " + c);
    }
  } else
    (a = goog.dom.createDom('xml')),
...
Blockly.Events.Change.prototype.run = function(a) {
  var b = Blockly.Workspace.getById(this.workspaceId).getBlockById(
    this.blockId
  );
  if (b)
    switch (
...
Blockly.Events.Move.prototype.run = function(a) {
  ...
  if (c) {
    ...
    if (a) (e = c.getRelativeToSurfaceXY()), c.moveBy(a.x - e.x, a.y - e.y);
      ...
      g
        ? c.connect(g)
        : console.warn("Can't connect to non-existant input: " + e);
    }
...
Blockly.FieldTextInput.prototype.showEditor_ = function(a) {
  ...
  if (
    ...
    this.resizeEditor_();
    a || (d.focus(), d.select());
    d.onKeyDownWrapper_ = Blockly.bindEventWithChecks_(
      d,
      'keydown',
      this,
      this.onHtmlInputKeyDown_
    );
    d.onKeyUpWrapper_ = Blockly.bindEventWithChecks_(
      d,
      'keyup',
      this,
      this.onHtmlInputChange_
    );
    d.onKeyPressWrapper_ = Blockly.bindEventWithChecks_(
      d,
      'keypress',
      this,
      this.onHtmlInputChange_
...
Blockly.FieldTextInput.prototype.onHtmlInputKeyDown_ = function(a) {
  ...
  13 == a.keyCode
    ...
    : 27 == a.keyCode
    ? ((b.value = b.defaultValue), Blockly.WidgetDiv.hide())
    : 9 == a.keyCode &&
      (Blockly.WidgetDiv.hide(),
...
Blockly.FieldTextInput.prototype.onHtmlInputChange_ = function(a) {
  ...
  var b = a.value;
  b !== a.oldValue_
    ? ((a.oldValue_ = b), this.setValue(b), this.validate_())
...
Blockly.FieldTextInput.prototype.validate_ = function() {
  ...
  null === a
    ? Blockly.utils.addClass(b, 'blocklyInvalidInput')
    : Blockly.utils.removeClass(b, 'blocklyInvalidInput');
};
...
Blockly.FieldAngle.prototype.showEditor_ = function() {
  ...
  var a = Blockly.WidgetDiv.DIV;
  if (a.firstChild) {
    var a = Blockly.utils.createSvgElement(
        'svg',
        {
...
Blockly.FieldAngle.prototype.onMouseMove = function(a) {
  ...
  isNaN(b) ||
    ...
    0 > c ? (b += 180) : 0 < a && (b += 360),
    (b = Blockly.FieldAngle.CLOCKWISE
      ? Blockly.FieldAngle.OFFSET + 360 - b
      : b - Blockly.FieldAngle.OFFSET),
...
Blockly.FieldDropdown.prototype.showEditor_ = function() {
  ...
  f = this.getAbsoluteXY_();
  e = this.getScaledBBox_();
  b.render(Blockly.WidgetDiv.DIV);
  g = b.getElement();
  Blockly.utils.addClass(g, 'blocklyDropdownMenu');
  var h = goog.style.getSize(g);
  h.height = g.scrollHeight;
  f.y =
    f.y + h.height + e.height >= c.height + d.y
      ? f.y - (h.height + 2)
      : f.y + e.height;
  this.sourceBlock_.RTL
    ? ((f.x += e.width),
      (f.x += Blockly.FieldDropdown.CHECKMARK_OVERHANG),
      f.x < d.x + h.width && (f.x = d.x + h.width))
    : ((f.x -= Blockly.FieldDropdown.CHECKMARK_OVERHANG),
      f.x > c.width + d.x - h.width && (f.x = c.width + d.x - h.width));
  Blockly.WidgetDiv.position(f.x, f.y, c, d, this.sourceBlock_.RTL);
...
Blockly.FieldDropdown.prototype.trimOptions_ = function() {
  ...
  if (goog.isArray(a) && !(2 > a.length)) {
    ...
    var c = Blockly.utils.shortestStringLength(b),
      e = Blockly.utils.commonWordPrefix(b, c),
      f = Blockly.utils.commonWordSuffix(b, c);
    if ((e || f) && !(c <= e + f)) {
      e && (this.prefixField = b[0].substring(0, e - 1));
      f && (this.suffixField = b[0].substr(1 - f));
      b = [];
      for (c = 0; c < a.length; c++) {
        var d = a[c][0],
          g = a[c][1],
          d = d.substring(e, d.length - f);
        b[c] = [d, g];
      }
  ...
  if (null !== a && a !== this.value_) {
    ...
    for (var b = this.getOptions_(), c = 0; c < b.length; c++)
      if (b[c][1] == a) {
        a = b[c][0];
        'object' == typeof a
          ? ((this.imageJson_ = a), this.setText(a.alt))
          : ((this.imageJson_ = null), this.setText(a));
        return;
      }
    this.setText(a);
  }
...
Blockly.FieldDropdown.prototype.render_ = function() {
  if (this.visible_) {
    ...
    if (this.imageJson_) {
      ...
      (a = document.createTextNode(this.getDisplayText_())),
        this.textElement_.appendChild(a),
        this.sourceBlock_.RTL
          ? this.textElement_.insertBefore(
              this.arrow_,
...
Blockly.Variables.allVariables = function(a) {
  a instanceof Blockly.Block &&
    console.warn(
      'Deprecated call to Blockly.Variables.allVariables with a block instead of a workspace.  You may want Blockly.Variables.allUsedVariables'
    );
...
Blockly.Variables.flyoutCategory = function(a) {
  ...
  var c = [],
    d = goog.dom.createDom('button');
  d.setAttribute('text', Blockly.Msg.NEW_VARIABLE);
  ...
  if (0 < b.length) {
    Blockly.Blocks.variables_set &&
      ...
      a.setAttribute('type', 'variables_set'),
      Blockly.Blocks.math_change
        ? a.setAttribute('gap', 8)
        : a.setAttribute('gap', 24),
      (d = goog.dom.createDom('field', null, b[0])),
      d.setAttribute('name', 'VAR'),
      a.appendChild(d),
      c.push(a));
    if (Blockly.Blocks.math_change) {
      a = goog.dom.createDom('block');
      a.setAttribute('type', 'math_change');
      Blockly.Blocks.variables_get && a.setAttribute('gap', 20);
    ...
    for (e = 0; e < b.length; e++)
      Blockly.Blocks.variables_get &&
        ((a = goog.dom.createDom('block')),
        a.setAttribute('type', 'variables_get'),
        Blockly.Blocks.variables_set && a.setAttribute('gap', 8),
        (d = goog.dom.createDom('field', null, b[e])),
        d.setAttribute('name', 'VAR'),
        a.appendChild(d),
        c.push(a));
  }
...
Blockly.Variables.createVariable = function(a, b) {
  var c = function(d) {
    Blockly.Variables.promptName(Blockly.Msg.NEW_VARIABLE_TITLE, d, function(
      d
    ) {
      d
        ? -1 != a.variableIndexOf(d)
          ? Blockly.alert(
...
Blockly.FieldVariable.dropdownCreate = function() {
  var a =
      this.sourceBlock_ && this.sourceBlock_.workspace
        ? this.sourceBlock_.workspace.variableList.slice(0)
        : [],
    b = this.getText();
...
Blockly.FieldVariable.prototype.onItemSelected = function(a, b) {
  ...
  if (this.sourceBlock_) {
    ...
    if (
      0 <= this.renameVarItemIndex_ &&
      a.getChildAt(this.renameVarItemIndex_) === b
    ) {
      var e = this.getText();
      Blockly.hideChaff();
      Blockly.Variables.promptName(
        Blockly.Msg.RENAME_VARIABLE_TITLE.replace('%1', e),
        e,
        function(a) {
    ...
    if (
      0 <= this.deleteVarItemIndex_ &&
      a.getChildAt(this.deleteVarItemIndex_) === b
    ) {
...
Blockly.Generator.prototype.blockToCode = function(a) {
  ...
  if (goog.isArray(b))
    return (
      goog.asserts.assert(
        a.outputConnection,
        'Expecting string from statement block "%s".',
        a.type
      ),
  ...
  if (goog.isString(b)) {
    ...
    this.STATEMENT_PREFIX &&
      (b = this.STATEMENT_PREFIX.replace(/%1/g, "'" + c + "'") + b);
...
Blockly.Generator.prototype.valueToCode = function(a, b, c) {
  isNaN(c) &&
    goog.asserts.fail('Expecting valid order from block "%s".', a.type);
  ...
  b = b[1];
  isNaN(b) &&
    goog.asserts.fail('Expecting valid order from value block "%s".', d.type);
  if (!a) return '';
  var d = !1,
    e = Math.floor(c),
    f = Math.floor(b);
...
Blockly.FlyoutButton = function(a, b, c, d) {
  ...
  this.isLabel_ && a
    ...
    : this.isLabel_ || (a && b.getButtonCallback(a))
    ? (this.callback_ = b.getButtonCallback(a))
...
Blockly.Flyout.prototype.setMetrics_ = function(a) {
  ...
  b &&
    (!this.horizontalLayout_ && goog.isNumber(a.y)
  ...
  if (this.isVisible()) {
    ...
    if (a) {
      ...
      this.toolboxPosition_ == Blockly.TOOLBOX_AT_RIGHT &&
        ((b += a.viewWidth), (b -= this.width_));
      var c = a.absoluteTop;
      this.toolboxPosition_ == Blockly.TOOLBOX_AT_BOTTOM &&
        ((c += a.viewHeight), (c -= this.height_));
      this.horizontalLayout_
        ? (this.width_ = a.viewWidth)
        : (this.height_ = a.viewHeight);
      this.svgGroup_.setAttribute('width', this.width_);
      this.svgGroup_.setAttribute('height', this.height_);
      this.svgGroup_.style.transform = 'translate(' + b + 'px,' + c + 'px)';
      this.scrollbar_ &&
        (this.scrollbar_.setOrigin(b, c), this.scrollbar_.resize());
    }
  }
};
Blockly.Flyout.prototype.setBackgroundPath_ = function(a, b) {
  this.horizontalLayout_
    ? this.setBackgroundPathHorizontal_(a, b)
    : this.setBackgroundPathVertical_(a, b);
};
  ...
  if (b) {
    ...
    var c = this.getMetrics_(),
      ...
      b = Math.min(
        b,
        this.horizontalLayout_
          ? c.contentWidth - c.viewWidth
          : c.contentHeight - c.viewHeight
      ),
      b = Math.max(b, 0);
...
Blockly.Flyout.prototype.updateDisplay_ = function() {
  var a;
  a = this.containerVisible_ ? this.isVisible() : !1;
...
Blockly.Flyout.prototype.show = function(a) {
  ...
  a == Blockly.Variables.NAME_TYPE
    ...
    : a == Blockly.Procedures.NAME_TYPE &&
      (a = Blockly.Procedures.flyoutCategory(this.workspace_.targetWorkspace));
  this.setVisible(!0);
  for (
    var b = [], c = [], d = (this.permanentlyDisabled_.length = 0), e;
    (e = a[d]);
    d++
  )
    if (e.tagName) {
      ...
      if ('BLOCK' == f)
        ...
        (e = new Blockly.FlyoutButton(
          this.workspace_,
          this.targetWorkspace_,
          e,
          'LABEL' == f
        )),
          b.push({ type: 'button', button: e }),
          c.push(g);
    }
  this.layout_(b, c);
  ...
  for (var e = 0, f; (f = a[e]); e++)
    if ('block' == f.type) {
      ...
      this.horizontalLayout_
        ? (d += h.width + b[e] - k)
        : (c += h.height + b[e]);
      h = Blockly.utils.createSvgElement('rect', { 'fill-opacity': 0 }, null);
      h.tooltip = f;
...
Blockly.Flyout.prototype.blockMouseDown_ = function(a) {
  var b = this;
  return function(c) {
    Blockly.utils.isRightButton(c)
      ? Blockly.Flyout.blockRightClick_(c, a)
      : (Blockly.terminateDrag_(),
        Blockly.hideChaff(!0),
        Blockly.Css.setCursor(Blockly.Css.Cursor.CLOSED),
        ...
        (Blockly.Flyout.onMouseUpWrapper_ = Blockly.bindEventWithChecks_(
          document,
          'mouseup',
          b,
          b.onMouseUp_
...
Blockly.Flyout.prototype.onMouseDown_ = function(a) {
  Blockly.utils.isRightButton(a)
    ...
    : (Blockly.hideChaff(!0),
      ...
      (Blockly.Flyout.onMouseMoveWrapper_ = Blockly.bindEventWithChecks_(
        document,
        'mousemove',
        this,
        this.onMouseMove_
...
Blockly.Flyout.prototype.onMouseUp_ = function(a) {
  this.workspace_.isDragging() ||
    ...
    this.autoClose
      ...
      : Blockly.WidgetDiv.isVisible() ||
        Blockly.Events.fire(
          new Blockly.Events.Ui(
            Blockly.Flyout.startBlock_,
            'click',
            void 0,
            void 0
          )
...
Blockly.Flyout.prototype.onMouseMove_ = function(a) {
  ...
  if (this.horizontalLayout_) {
    ...
    0 > b.contentHeight - b.viewHeight ||
      ((c = a.clientY - this.startDragMouseY_),
      (this.startDragMouseY_ = a.clientY),
      (a = b.viewTop - c),
...
Blockly.Flyout.prototype.onMouseMoveBlock_ = function(a) {
  ('mousemove' == a.type &&
    ...
    0 == a.clientY &&
    0 == a.button) ||
    (this.determineDragIntention_(
      a.clientX - Blockly.Flyout.startDownEvent_.clientX,
      a.clientY - Blockly.Flyout.startDownEvent_.clientY
    )
      ? (Blockly.longStop_(),
        this.createBlockFunc_(Blockly.Flyout.startBlock_)(
          Blockly.Flyout.startDownEvent_
      ...
      : this.dragMode_ == Blockly.DRAG_FREE &&
        (Blockly.longStop_(), this.onMouseMove_(a)));
  a.stopPropagation();
};
Blockly.Flyout.prototype.determineDragIntention_ = function(a, b) {
  ...
  if (Math.sqrt(a * a + b * b) < this.DRAG_RADIUS)
    return (this.dragMode_ = Blockly.DRAG_STICKY), !1;
...
Blockly.Flyout.prototype.isDragTowardWorkspace_ = function(a, b) {
  ...
  if (this.horizontalLayout_) {
    if ((c < 90 + d && c > 90 - d) || (c > -90 - d && c < -90 + d)) return !0;
  } else if ((c < d && c > -d) || c < -180 + d || c > 180 - d) return !0;
  return !1;
};
Blockly.Flyout.prototype.createBlockFunc_ = function(a) {
  var b = this;
  return function(c) {
    if (!Blockly.utils.isRightButton(c) && !a.disabled) {
      Blockly.Events.disable();
...
Blockly.Flyout.prototype.placeNewBlock_ = function(a) {
  ...
  var c = b.isMutator
      ? this.workspace_.getSvgXY(c)
      : Blockly.utils.getInjectionDivXY_(c),
    d = this.workspace_.scrollX,
    e = this.workspace_.scale;
  c.x += d / e - d;
  this.toolboxPosition_ == Blockly.TOOLBOX_AT_RIGHT &&
    ((d = b.getMetrics().viewWidth - this.width_),
    (e = b.scale),
    (c.x += d / e - d));
  ...
  c.y += d / e - d;
  this.toolboxPosition_ == Blockly.TOOLBOX_AT_BOTTOM &&
    ((d = b.getMetrics().viewHeight - this.height_),
    (e = b.scale),
    (c.y += d / e - d));
  ...
  e = b.isMutator ? b.getSvgXY(e) : Blockly.utils.getInjectionDivXY_(e);
  e.x += b.scrollX / b.scale - b.scrollX;
  e.y += b.scrollY / b.scale - b.scrollY;
  b.toolbox_ &&
    !b.scrollbar &&
    ((e.x += b.toolbox_.getWidth() / b.scale),
...
Blockly.Flyout.prototype.getClientRect = function() {
  ...
  return this.toolboxPosition_ == Blockly.TOOLBOX_AT_TOP
    ? new goog.math.Rect(-1e9, c - 1e9, 2e9, 1e9 + a)
    : this.toolboxPosition_ == Blockly.TOOLBOX_AT_BOTTOM
    ? new goog.math.Rect(-1e9, c, 2e9, 1e9 + a)
    : this.toolboxPosition_ == Blockly.TOOLBOX_AT_LEFT
    ? new goog.math.Rect(b - 1e9, -1e9, 1e9 + d, 2e9)
    : new goog.math.Rect(b, -1e9, 1e9 + d, 2e9);
};
  ...
  if (this.height_ != b) {
    for (c = 0; (d = a[c]); c++) {
      ...
      if (d.flyoutRect_) {
        ...
        (e = d.startHat_ ? Blockly.BlockSvg.START_HAT_HEIGHT : 0) &&
          d.moveBy(0, e);
        d.flyoutRect_.setAttribute('y', g.y);
      }
    }
      ...
      switch (g.tagName.toUpperCase()) {
        case 'CATEGORY':
          ...
          goog.isString(h)
            ? (h.match(/^#[0-9a-fA-F]{6}$/)
                ? (e.hexColour = h)
                : (e.hexColour = Blockly.hueToRgb(h)),
              (this.hasColours_ = !0))
            : (e.hexColour = '');
          'true' == g.getAttribute('expanded')
            ? (e.blocks.length && (d = e), e.setExpanded(!0))
            : e.setExpanded(!1);
          e = g;
          break;
        case 'SEP':
          e &&
            ('CATEGORY' == e.tagName.toUpperCase()
              ? b.add(
                  new Blockly.Toolbox.TreeSeparator(this.treeSeparatorConfig_)
                )
              : ((g = parseFloat(g.getAttribute('gap'))),
...
Blockly.Toolbox.prototype.getClientRect = function() {
  ...
  var a = this.HtmlDiv.getBoundingClientRect(),
    ...
    d = a.width,
    a = a.height;
  return this.toolboxPosition == Blockly.TOOLBOX_AT_LEFT
    ? new goog.math.Rect(-1e7, -1e7, 1e7 + b + d, 2e7)
    : this.toolboxPosition == Blockly.TOOLBOX_AT_RIGHT
    ? new goog.math.Rect(b, -1e7, 1e7 + d, 2e7)
    : this.toolboxPosition == Blockly.TOOLBOX_AT_TOP
    ? new goog.math.Rect(-1e7, -1e7, 2e7, 1e7 + c + a)
    : new goog.math.Rect(0, c, 2e7, 1e7 + d);
};
...
Blockly.BlockDragSurfaceSvg.prototype.setBlocksAndShow = function(a) {
  goog.asserts.assert(
    0 == this.dragGroup_.childNodes.length,
    'Already dragging a block.'
  );
...
Blockly.inject = function(a, b) {
  ...
  Blockly.init_(c);
  c.markFocused();
  Blockly.bindEventWithChecks_(e, 'focus', c, c.markFocused);
  Blockly.svgResize(c);
  return c;
};
Blockly.createDom_ = function(a, b) {
  ...
  var c = Blockly.utils.createSvgElement(
      'svg',
      {
        xmlns: 'http://www.w3.org/2000/svg',
        'xmlns:html': 'http://www.w3.org/1999/xhtml',
    ...
    f = Blockly.utils.createSvgElement(
      'filter',
  ...
  var g = Blockly.utils.createSvgElement(
    'feSpecularLighting',
    {
      in: 'blur',
      surfaceScale: 1,
  ...
  d = Blockly.utils.createSvgElement(
    'pattern',
    { id: 'blocklyGridPattern' + e, patternUnits: 'userSpaceOnUse' },
    d
  );
  0 < b.gridOptions.length &&
    0 < b.gridOptions.spacing &&
    (Blockly.utils.createSvgElement(
      'line',
...
Blockly.createMainWorkspace_ = function(a, b, c, d) {
  ...
  !b.hasCategories &&
    b.languageTree &&
    ((c = e.addFlyout_('svg')), Blockly.utils.insertAfter_(c, a));
  e.translate(0, 0);
  e.markFocused();
  b.readOnly ||
    b.hasScrollbars ||
    e.addChangeListener(function() {
      if (Blockly.dragMode_ == Blockly.DRAG_NONE) {
        ...
        if (
          a.contentTop < d ||
          a.contentTop + a.contentHeight > a.viewHeight + d ||
          a.contentLeft < (b.RTL ? a.viewLeft : c) ||
          a.contentLeft + a.contentWidth >
            (b.RTL ? a.viewWidth : a.viewWidth + c)
        )
...
Blockly.inject.loadSounds_ = function(a, b) {
  ...
  b.loadAudio_(
    [a + 'delete.mp3', a + 'delete.ogg', a + 'delete.wav'],
    'delete'
  );
  var c = [],
    d = function() {
    ...
    if (27 == a.keyCode) Blockly.hideChaff();
      ...
      Blockly.selected &&
        ...
        (67 == a.keyCode
          ...
          : 88 == a.keyCode && (Blockly.copy_(Blockly.selected), (b = !0))),
        86 == a.keyCode
          ? Blockly.clipboardXml_ &&
            ...
            Blockly.Events.setGroup(!1))
          : 90 == a.keyCode &&
            (Blockly.hideChaff(), Blockly.mainWorkspace.undo(a.shiftKey));
    b &&
      (Blockly.Events.setGroup(!0),
      Blockly.hideChaff(),
...
Blockly.defineBlocksWithJsonArray = function(a) {
  for (var b = 0, c; (c = a[b]); b++)
    Blockly.Blocks[c.type] = { init: Blockly.jsonInitFactory_(c) };
};
  ...
  if (b in Blockly.Touch.TOUCH_MAP)
    for (
      var k = function(a) {
        ...
        n = 0,
        p;
      (p = Blockly.Touch.TOUCH_MAP[b][n]);
      n++
    )
      a.addEventListener(p, k, !1), h.push([a, p, k]);
  return h;
};
...
goog.global.console ||
  (goog.global.console = { log: function() {}, warn: function() {} });
goog.global.Blockly || (goog.global.Blockly = {});
