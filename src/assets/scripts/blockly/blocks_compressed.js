...
Blockly.Blocks.lists_create_with = {
  ...
  decompose: function(a) {
    ...
    b.initSvg();
    for (
      var c = b.getInput('STACK').connection, e = 0;
      e < this.itemCount_;
      e++
    ) {
    ...
    this.setTooltip(function() {
      ...
      if ('FROM_START' == e || 'FROM_END' == e)
        d +=
          ...
          ).replace('%1', b.workspace.options.oneBasedIndex ? '#1' : '#0');
      return d;
    });
  },
  mutationToDom: function() {
      ...
      if ('FROM_START' == e || 'FROM_END' == e)
        d +=
          ...
          Blockly.Msg.LISTS_INDEX_FROM_START_TOOLTIP.replace(
            '%1',
            b.workspace.options.oneBasedIndex ? '#1' : '#0'
          );
      return d;
    });
  },
...
Blockly.Blocks.procedures_defnoreturn = {
  ...
  renameVar: function(a, b) {
    for (var c = !1, e = 0; e < this.arguments_.length; e++)
      Blockly.Names.equals(a, this.arguments_[e]) &&
        ((this.arguments_[e] = b), (c = !0));
    if (c && (this.updateParams_(), this.mutator.isVisible()))
      for (
        var c = this.mutator.workspace_.getAllBlocks(), e = 0, d;
        (d = c[e]);
        e++
      )
        'procedures_mutatorarg' == d.type &&
          Blockly.Names.equals(a, d.getFieldValue('NAME')) &&
          d.setFieldValue(b, 'NAME');
  },
  customContextMenu: function(a) {
    var b = { enabled: !0 },
...
Blockly.Blocks.procedures_mutatorarg = {
  ...
  createNewVar_: function(a) {
    ...
    b &&
      b.workspace &&
      b.workspace.options &&
      b.workspace.options.parentWorkspace &&
      b.workspace.options.parentWorkspace.createVariable(a);
  },
};
Blockly.Blocks.procedures_callnoreturn = {
      ...
      if (goog.array.equals(this.arguments_, a)) this.quarkIds_ = b;
        ...
        for (var d = 0; d < this.arguments_.length; d++) {
          ...
          f &&
            ...
            (this.quarkConnections_[this.quarkIds_[d]] = f),
            e &&
              f &&
              -1 == b.indexOf(this.quarkIds_[d]) &&
              (f.disconnect(), f.getSourceBlock().bumpNeighbours_()));
        }
          ...
          for (d = 0; d < this.arguments_.length; d++)
            (e = this.quarkIds_[d]),
              e in this.quarkConnections_ &&
                ((f = this.quarkConnections_[e]),
                Blockly.Mutator.reconnect(f, this, 'ARG' + d) ||
                  delete this.quarkConnections_[e]);
  ...
  domToMutation: function(a) {
    ...
    for (var b = [], c = [], e = 0, d; (d = a.childNodes[e]); e++)
      'arg' == d.nodeName.toLowerCase() &&
        (b.push(d.getAttribute('name')), c.push(d.getAttribute('paramId')));
    this.setProcedureParameters_(b, c);
  },
  renameVar: function(a, b) {
    for (var c = 0; c < this.arguments_.length; c++)
      Blockly.Names.equals(a, this.arguments_[c]) &&
        ((this.arguments_[c] = b), this.getField('ARGNAME' + c).setValue(b));
  },
  onchange: function(a) {
...
Blockly.Blocks.text = {
  init: function() {
    ...
    this.setTooltip(function() {
      var b = a.getParent();
      return (
        (b && b.getInputsInline() && b.tooltip) || Blockly.Msg.TEXT_TEXT_TOOLTIP
      );
    });
  },
      ...
      if ('FROM_START' == b || 'FROM_END' == b)
        c +=
          ...
          ('FROM_START' == b
            ? Blockly.Msg.LISTS_INDEX_FROM_START_TOOLTIP
            : Blockly.Msg.LISTS_INDEX_FROM_END_TOOLTIP
          ).replace('%1', a.workspace.options.oneBasedIndex ? '#1' : '#0');
      return c;
    });
  },
  mutationToDom: function() {
...
Blockly.Blocks.controls_if = {
  ...
  compose: function(a) {
    ...
    for (b = 1; b <= this.elseifCount_; b++)
      Blockly.Mutator.reconnect(a[b], this, 'IF' + b),
  ...
  onchange: function(a) {
    ...
    if ((b || c) && e)
      for (var d = 0; 2 > d; d++) {
        var f = 1 == d ? b : c;
        f &&
          !f.outputConnection.checkType_(e) &&
          (Blockly.Events.setGroup(a.group),
          e === this.prevParentConnection_
            ? (this.unplug(), e.getSourceBlock().bumpNeighbours_())
