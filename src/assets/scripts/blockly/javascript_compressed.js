...
Blockly.JavaScript.scrub_ = function(a, b) {
  ...
  if (!a.outputConnection || !a.outputConnection.targetConnection) {
    ...
    (d = Blockly.utils.wrap(d, Blockly.JavaScript.COMMENT_WRAP - 3)) &&
      (c = a.getProcedureDef
        ? c +
    ...
    for (var e = 0; e < a.inputList.length; e++)
      a.inputList[e].type == Blockly.INPUT_VALUE &&
        ...
        (d = Blockly.JavaScript.allNestedComments(d)) &&
        (c += Blockly.JavaScript.prefixLines(d, '// '));
  }
...
Blockly.JavaScript.getAdjusted = function(a, b, c, d, e) {
  ...
  a =
    0 < c
      ...
      : Blockly.JavaScript.valueToCode(a, b, e) || f;
  if (Blockly.isNumber(a)) (a = parseFloat(a) + c), d && (a = -a);
    ...
    if (0 < c) {
      ...
      0 > c &&
        ((a = a + ' - ' + -c), (g = Blockly.JavaScript.ORDER_SUBTRACTION));
    d &&
      ((a = c ? '-(' + a + ')' : '-' + a),
      (g = Blockly.JavaScript.ORDER_UNARY_NEGATION));
    g = Math.floor(g);
    e = Math.floor(e);
    g && e >= g && (a = '(' + a + ')');
  }
...
Blockly.JavaScript.lists_repeat = function(a) {
  var b = Blockly.JavaScript.provideFunction_('listsRepeat', [
      'function ' +
  ...
  a =
    Blockly.JavaScript.valueToCode(a, 'NUM', Blockly.JavaScript.ORDER_COMMA) ||
    '0';
...
Blockly.JavaScript.lists_indexOf = function(a) {
  ...
  return a.workspace.options.oneBasedIndex
    ? [b + ' + 1', Blockly.JavaScript.ORDER_ADDITION]
...
Blockly.JavaScript.lists_getIndex = function(a) {
  ...
  switch (c) {
    ...
    case 'RANDOM':
      d =
        Blockly.JavaScript.provideFunction_('listsGetRandomItem', [
          'function ' +
            Blockly.JavaScript.FUNCTION_NAME_PLACEHOLDER_ +
            '(list, remove) {',
...
Blockly.JavaScript.lists_setIndex = function(a) {
  ...
  switch (e) {
    ...
    case 'FROM_START':
      ...
      break;
    case 'FROM_END':
      e = Blockly.JavaScript.getAdjusted(
        a,
        'AT',
        1,
        !1,
  ...
  if ('FIRST' == c && 'LAST' == d) b += '.slice(0)';
    ...
    switch (d) {
      case 'FROM_START':
        ...
        break;
      case 'FROM_END':
        a = Blockly.JavaScript.getAdjusted(
          a,
          'AT2',
          0,
          !1,
    ...
    var f = Blockly.JavaScript.lists.getIndex_,
      ...
      b =
        Blockly.JavaScript.provideFunction_('subsequence' + g[c] + g[d], [
          'function ' +
            Blockly.JavaScript.FUNCTION_NAME_PLACEHOLDER_ +
            '(sequence' +
...
Blockly.JavaScript.lists_sort = function(a) {
  ...
  var d = Blockly.JavaScript.provideFunction_('listsGetSortCompare', [
    'function ' +
      Blockly.JavaScript.FUNCTION_NAME_PLACEHOLDER_ +
      '(type, direction) {',
    '  var compareFuncs = {',
...
Blockly.JavaScript.math_number_property = function(a) {
  ...
  if ('PRIME' == c)
    return [
      Blockly.JavaScript.provideFunction_('mathIsPrime', [
...
Blockly.JavaScript.math_change = function(a) {
  ...
  a = Blockly.JavaScript.variableDB_.getName(
    a.getFieldValue('VAR'),
    Blockly.Variables.NAME_TYPE
  );
...
Blockly.JavaScript.math_on_list = function(a) {
  ...
  switch (b) {
    ...
    case 'AVERAGE':
      ...
      break;
    case 'MEDIAN':
      b = Blockly.JavaScript.provideFunction_('mathMedian', [
        'function ' +
          Blockly.JavaScript.FUNCTION_NAME_PLACEHOLDER_ +
          '(myList) {',
      ...
      break;
    case 'MODE':
      b = Blockly.JavaScript.provideFunction_('mathModes', [
        'function ' +
          Blockly.JavaScript.FUNCTION_NAME_PLACEHOLDER_ +
          '(values) {',
        '  var modes = [];',
      ...
      break;
    case 'STD_DEV':
      b = Blockly.JavaScript.provideFunction_('mathStandardDeviation', [
        'function ' +
          Blockly.JavaScript.FUNCTION_NAME_PLACEHOLDER_ +
          '(numbers) {',
      ...
      break;
    case 'RANDOM':
      b = Blockly.JavaScript.provideFunction_('mathRandomList', [
        'function ' +
          Blockly.JavaScript.FUNCTION_NAME_PLACEHOLDER_ +
          '(list) {',
        '  var x = Math.floor(Math.random() * list.length);',
...
Blockly.JavaScript.math_constrain = function(a) {
  ...
  a =
    Blockly.JavaScript.valueToCode(a, 'HIGH', Blockly.JavaScript.ORDER_COMMA) ||
    'Infinity';
  return [
...
Blockly.JavaScript.math_random_int = function(a) {
  var b =
    Blockly.JavaScript.valueToCode(a, 'FROM', Blockly.JavaScript.ORDER_COMMA) ||
    '0';
  a =
    Blockly.JavaScript.valueToCode(a, 'TO', Blockly.JavaScript.ORDER_COMMA) ||
    '0';
  return [
    Blockly.JavaScript.provideFunction_('mathRandomInt', [
...
Blockly.JavaScript.colour_random = function(a) {
  return [
    Blockly.JavaScript.provideFunction_('colourRandom', [
...
Blockly.JavaScript.colour_rgb = function(a) {
  ...
  a =
    Blockly.JavaScript.valueToCode(a, 'BLUE', Blockly.JavaScript.ORDER_COMMA) ||
    0;
  return [
    Blockly.JavaScript.provideFunction_('colourRgb', [
      'function ' +
        Blockly.JavaScript.FUNCTION_NAME_PLACEHOLDER_ +
        '(r, g, b) {',
...
Blockly.JavaScript.colour_blend = function(a) {
  ...
  return [
    Blockly.JavaScript.provideFunction_('colourBlend', [
      'function ' +
        Blockly.JavaScript.FUNCTION_NAME_PLACEHOLDER_ +
        '(c1, c2, ratio) {',
...
Blockly.JavaScript.procedures_defreturn = function(a) {
  ...
  Blockly.JavaScript.STATEMENT_PREFIX &&
    (c =
      Blockly.JavaScript.prefixLines(
        Blockly.JavaScript.STATEMENT_PREFIX.replace(/%1/g, "'" + a.id + "'"),
        Blockly.JavaScript.INDENT
      ) + c);
  Blockly.JavaScript.INFINITE_LOOP_TRAP &&
    (c =
      Blockly.JavaScript.INFINITE_LOOP_TRAP.replace(/%1/g, "'" + a.id + "'") +
      c);
  var d =
    Blockly.JavaScript.valueToCode(
      a,
  ...
  for (var e = [], f = 0; f < a.arguments_.length; f++)
    e[f] = Blockly.JavaScript.variableDB_.getName(
      a.arguments_[f],
      Blockly.Variables.NAME_TYPE
    );
  c = 'function ' + b + '(' + e.join(', ') + ') {\n' + c + d + '}';
...
Blockly.JavaScript.text = function(a) {
  return [
    Blockly.JavaScript.quote_(a.getFieldValue('TEXT')),
    Blockly.JavaScript.ORDER_ATOMIC,
  ];
};
...
Blockly.JavaScript.text_charAt = function(a) {
  ...
  switch (b) {
    ...
    case 'RANDOM':
      return [
        Blockly.JavaScript.provideFunction_('textRandomLetter', [
          'function ' +
            Blockly.JavaScript.FUNCTION_NAME_PLACEHOLDER_ +
            '(text) {',
...
Blockly.JavaScript.text_changeCase = function(a) {
  ...
  return [
    b
      ? a + b
      : Blockly.JavaScript.provideFunction_('textToTitleCase', [
          'function ' +
            Blockly.JavaScript.FUNCTION_NAME_PLACEHOLDER_ +
            '(str) {',
  ...
  var b = 'UNTIL' == a.getFieldValue('MODE'),
    c =
      Blockly.JavaScript.valueToCode(
        a,
        'BOOL',
        b ? Blockly.JavaScript.ORDER_LOGICAL_NOT : Blockly.JavaScript.ORDER_NONE
      ) || 'false',
...
Blockly.JavaScript.controls_for = function(a) {
  ...
  if (Blockly.isNumber(c) && Blockly.isNumber(d) && Blockly.isNumber(e)) {
    ...
    (a = ''),
      ...
      c.match(/^\w+$/) ||
        Blockly.isNumber(c) ||
        ((g = Blockly.JavaScript.variableDB_.getDistinctName(
          b + '_start',
          Blockly.Variables.NAME_TYPE
        )),
        (a += 'var ' + g + ' = ' + c + ';\n')),
      ...
      d.match(/^\w+$/) ||
        Blockly.isNumber(d) ||
        ((c = Blockly.JavaScript.variableDB_.getDistinctName(
          b + '_end',
          Blockly.Variables.NAME_TYPE
        )),
        (a += 'var ' + c + ' = ' + d + ';\n')),
      (d = Blockly.JavaScript.variableDB_.getDistinctName(
        b + '_inc',
        Blockly.Variables.NAME_TYPE
      )),
      (a += 'var ' + d + ' = '),
...
Blockly.JavaScript.controls_if = function(a) {
  ...
  a.getInput('ELSE') &&
    ((d = Blockly.JavaScript.statementToCode(a, 'ELSE')),
    (c += ' else {\n' + d + '}'));
  return c + '\n';
};
