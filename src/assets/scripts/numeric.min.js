...
typeof global != 'undefined' && (global.numeric = numeric),
  (numeric.version = '1.2.6'),
  (numeric.bench = function(t, n) {
    var r, i, s, o;
    typeof n == 'undefined' && (n = 15), (s = 0.5), (r = new Date());
    for (;;) {
      s *= 2;
  ...
  (numeric.prettyPrint = function(t) {
    function n(e) {
      if (e === 0) return '0';
      ...
      if (isFinite(e)) {
        ...
        return (
          parseFloat(i) === 10 &&
            (t++, (r = 1), (i = r.toPrecision(numeric.precision))),
          parseFloat(i).toString() + 'e' + t.toString()
        );
      }
      return 'Infinity';
    }
    function i(e) {
      ...
      if (typeof e == 'number') {
        ...
        return (
          r.push(Array(numeric.precision + 8 - s.length).join(' ') + s), !1
        );
      }
  ...
  (numeric.imageURL = function(t) {
    function n(e) {
      ...
      for (n = 0; n < t; n += 3)
        (r = e[n]),
          ...
          (a = ((i & 15) << 2) + (s >> 6)),
          (f = s & 63),
          n + 1 >= t ? (a = f = 64) : n + 2 >= t && (f = 64),
          (c += l.charAt(o) + l.charAt(u) + l.charAt(a) + l.charAt(f));
      return c;
    }
    function r(e, t, n) {
      typeof t == 'undefined' && (t = 0),
        typeof n == 'undefined' && (n = e.length);
      var r = [
          0,
          1996959894,
          3993919788,
    ...
    for (p = 0; p < i; p++) {
      ...
      for (d = 0; d < s; d++)
        for (f = 0; f < 3; f++)
          (c = t[f][p][d]),
            c > 255 ? (c = 255) : c < 0 ? (c = 0) : (c = Math.round(c)),
            (o = (o + c) % 65521),
            (u = (u + o) % 65521),
            g.push(c);
      g.push(0);
  ...
  (numeric.dim = function(t) {
    ...
    if (typeof t == 'object')
      return (
        ...
        typeof n == 'object'
          ? ((r = n[0]),
            typeof r == 'object' ? numeric._dim(t) : [t.length, n.length])
          : [t.length]
      );
    return [];
  }),
  ...
  (numeric.dot = function(t, n) {
    ...
    switch (r(t).length * 1e3 + r(n).length) {
      case 2002:
        return n.length < 10
          ? numeric.dotMMsmall(t, n)
          : numeric.dotMMbig(t, n);
      case 2001:
  ...
  (numeric.pointwise = function(t, n, r) {
    ...
    for (s = 0; s < t.length; s++)
      o.test(t[s])
        ? ((u = t[s].substring(0, t[s].length - 3)), (a = u))
        : (u = t[s]),
        u === 'ret' && (f = !0),
        i.push(u);
    return (
  ...
  (function() {
    ...
    for (e in numeric.ops2)
      if (numeric.ops2.hasOwnProperty(e)) {
        ...
        var n,
          r,
          i = '';
        numeric.myIndexOf.call(numeric.mathfuns2, e) !== -1
          ? ((i = 'var ' + t + ' = Math.' + t + ';\n'),
            (n = function(e, n, r) {
              return e + ' = ' + t + '(' + n + ',' + r + ')';
            }),
          ...
          : ((n = function(e, n, r) {
            ...
            numeric.opseq.hasOwnProperty(e + 'eq')
              ? (r = function(e, n) {
                  return e + ' ' + t + '= ' + n;
                })
              : (r = function(e, n) {
    ...
    for (e in numeric.ops1)
      numeric.ops1.hasOwnProperty(e) &&
        ((i = ''),
        (t = numeric.ops1[e]),
        numeric.myIndexOf.call(numeric.mathfuns, e) !== -1 &&
  ...
  (numeric.setBlock = function(t, n, r, i) {
    function o(e, t, i) {
      var u,
        a = n[i],
        f = r[i] - a;
      if (i === s.length - 1) for (u = f; u >= 0; u--) e[u + a] = t[u];
  ...
  (numeric.T.prototype.div = function div(e) {
    ...
    var div = numeric.div;
    return this.y
      ? new numeric.T(div(this.x, e.x), div(this.y, e.x))
      : new numeric.T(div(this.x, e.x));
  }),
  ...
  (numeric.T.prototype.transjugate = function() {
    var t = numeric.transpose,
      ...
      r = this.y;
    return r
      ? new numeric.T(t(n), numeric.negtranspose(r))
      : new numeric.T(t(n));
  }),
  ...
  (numeric.T.prototype.set = function(t, n) {
    var r = this.x,
      ...
      f = n.y;
    if (u === 0)
      return f ? (this.y = f) : i && (this.y = undefined), (this.x = r), this;
    if (f) {
    ...
    if (i) {
      ...
      return (
        ...
        (r[o] = a),
        a instanceof Array
          ? (i[o] = numeric.rep(numeric.dim(a), 0))
          : (i[o] = 0),
        this
      );
    }
  ...
  (numeric.T.prototype.getBlock = function(t, n) {
    var r = this.x,
      ...
      s = numeric.getBlock;
    return i
      ? new numeric.T(s(r, t, n), s(i, t, n))
      : new numeric.T(s(r, t, n));
  }),
  (numeric.T.prototype.setBlock = function(t, n, r) {
    ...
    if (a)
      return (
        s || ((this.y = numeric.rep(numeric.dim(this), 0)), (s = this.y)),
        o(i, t, n, u),
        o(s, t, n, a),
        this
      );
  ...
  (numeric.toUpperHessenberg = function(t) {
    ...
    for (s = 0; s < r - 2; s++) {
      ...
      if (numeric.norm2(u) > 0) {
        (a = numeric.house(u)),
          (l = numeric.getBlock(f, [s + 1, s], [r - 1, r - 1])),
          (c = numeric.tensor(a, numeric.dot(a, l)));
        for (i = s + 1; i < r; i++) {
          (h = f[i]), (p = c[i - s - 1]);
          for (o = s; o < r; o++) h[o] -= 2 * p[o - s];
        }
        (l = numeric.getBlock(f, [0, s + 1], [r - 1, r - 1])),
          (c = numeric.tensor(numeric.dot(l, a), a));
        for (i = 0; i < r; i++) {
          (h = f[i]), (p = c[i]);
  ...
  (numeric.QRFrancis = function(e, t) {
    ...
    var n = numeric.clone(e),
      ...
      S,
      x;
    if (i < 3) return { Q: d, B: [[0, i - 1]] };
    var T = numeric.epsilon;
    for (x = 0; x < t; x++) {
      for (E = 0; E < i - 1; E++)
        if (
          Math.abs(e[E + 1][E]) <
          T * (Math.abs(e[E][E]) + Math.abs(e[E + 1][E + 1]))
        ) {
          var N = numeric.QRFrancis(numeric.getBlock(e, [0, 0], [E, E]), t),
            C = numeric.QRFrancis(
              numeric.getBlock(e, [E + 1, E + 1], [i - 1, i - 1]),
              t
            );
          g = Array(E + 1);
      ...
      (u = e[i - 2][i - 2]),
        ...
        (h = u + l),
        (c = u * l - a * f),
        (p = numeric.getBlock(e, [0, 0], [2, 2]));
      if (h * h >= 4 * c) {
        var k, L;
        (k = 0.5 * (h + Math.sqrt(h * h - 4 * c))),
          (L = 0.5 * (h - Math.sqrt(h * h - 4 * c))),
          (p = numeric.add(
            numeric.sub(numeric.dot(p, p), numeric.mul(p, k + L)),
            numeric.diag(numeric.rep([3], k * L))
          ));
      } else
        p = numeric.add(
          numeric.sub(numeric.dot(p, p), numeric.mul(p, h)),
          numeric.diag(numeric.rep([3], c))
        );
      (s = [p[0][0], p[1][0], p[2][0]]),
        (o = numeric.house(s)),
        (g = [e[0], e[1], e[2]]),
      ...
      (g = numeric.getBlock(e, [0, 0], [i - 1, 2])),
        (y = numeric.tensor(numeric.dot(g, o), o));
      for (w = 0; w < i; w++) {
        (m = e[w]), (b = y[w]);
      ...
      for (E = 0; E < i - 2; E++) {
        for (S = E; S <= E + 1; S++)
          if (
            Math.abs(e[S + 1][S]) <
            T * (Math.abs(e[S][S]) + Math.abs(e[S + 1][S + 1]))
          ) {
            var N = numeric.QRFrancis(numeric.getBlock(e, [0, 0], [S, S]), t),
              C = numeric.QRFrancis(
                numeric.getBlock(e, [S + 1, S + 1], [i - 1, i - 1]),
                t
              );
            g = Array(S + 1);
        ...
        (o = numeric.house(s)),
          (g = numeric.getBlock(e, [E + 1, E], [A, i - 1])),
          (y = numeric.tensor(o, numeric.dot(o, g)));
        for (w = E + 1; w <= A; w++) {
          (m = e[w]), (b = y[w - E - 1]);
          for (S = E; S < i; S++) m[S] -= 2 * b[S - E];
        }
        (g = numeric.getBlock(e, [0, E + 1], [i - 1, A])),
          (y = numeric.tensor(numeric.dot(g, o), o));
        for (w = 0; w < i; w++) {
          (m = e[w]), (b = y[w]);
  ...
  (numeric.eig = function(t, n) {
    ...
    for (v = 0; v < o; v++)
      if (v > 0)
        for (a = v - 1; a >= 0; a--) {
          ...
          (x = O.getRow(a).getBlock([a], [v - 1])),
            (T = M.getRow(v).getBlock([a], [v - 1])),
            M.set(
              [v, a],
              O.get([a, v])
                .neg()
    ...
    return (
      (M = M.transpose()),
      (M = h.transjugate().dot(M)),
      { lambda: O.getDiag(), E: M }
    );
  }),
  ...
  (numeric.ccsTSolve = function(t, n, r, i, s) {
    ...
    var o = t[0],
      ...
      l = Math.max,
      c = 0;
    typeof i == 'undefined' && (r = numeric.rep([f], 0)),
      typeof i == 'undefined' && (i = numeric.linspace(0, r.length - 1)),
  ...
  (numeric.sclone = function clone(e, t, n) {
    typeof t == 'undefined' && (t = 0),
      typeof n == 'undefined' && (n = numeric.sdim(e).length);
    var r,
      i = Array(e.length);
    if (t === n - 1) {
  ...
  (numeric.sdot = function(t, n) {
    ...
    switch (s) {
      ...
      default:
        throw new Error(
          'numeric.sdot not implemented for tensors of order ' + r + ' and ' + i
        );
    }
  }),
  ...
  (numeric.sgather = function gather(e, t, n) {
    ...
    for (i in e)
      if (e.hasOwnProperty(i)) {
        ...
        if (typeof s == 'number') {
          if (s) {
            if (t.length === 0) for (i = r + 1; i >= 0; --i) t[i] = [];
  ...
  (numeric.cLU = function(t) {
    ...
    var w = 0,
      E = 0;
    for (u = 0; u < o; u++)
      (d[u] = numeric.rep([m[u] - v[u] + 1], 0)),
        (p[u] = numeric.rep([u - v[u]], 0)),
        (w += u - v[u] + 1),
        (E += m[u] - u + 1);
  ...
  (numeric.Spline.prototype._at = function(t, n) {
    var r = this.x,
      ...
      h = numeric.sub,
      p = numeric.mul;
    (a = h(p(o[n], r[n + 1] - r[n]), h(s[n + 1], i[n]))),
      (f = c(p(u[n + 1], r[n] - r[n + 1]), h(s[n + 1], i[n]))),
      (l = (t - r[n]) / (r[n + 1] - r[n]));
    var d = l * (1 - l);
    return c(
      c(c(p(1 - l, i[n]), p(l, s[n + 1])), p(a, d * (1 - l))),
      p(f, d * l)
    );
  }),
  ...
  (numeric.Spline.prototype.diff = function() {
    ...
    for (u = o - 1; u !== -1; --u)
      (a = t[u + 1] - t[u]),
        (f = g(r[u + 1], n[u])),
        (h[u] = m(d(v(f, 6), v(i[u], -4 * a), v(s[u + 1], -2 * a)), a * a)),
        (p[u + 1] = m(d(v(f, -6), v(i[u], 2 * a), v(s[u + 1], 4 * a)), a * a));
      ...
      for (h = 0; h !== l; h++) {
        h > 0 && y[h] * g[h] < 0 && E.push(i[h]),
          ...
          L <= 0
            ...
            : ((_ = (C - F(L)) / k),
              (D = (C + F(L)) / k),
              (M = [i[h]]),
              _ > i[h] && _ < i[h + 1] && M.push(_),
              D > i[h] && D < i[h + 1] && M.push(D),
              M.push(i[h + 1])),
          (H = M[0]),
          (_ = this._at(H, h));
        for (p = 0; p < M.length - 1; p++) {
          ...
          for (;;) {
            ...
            if (j <= H || j >= B) break;
            P = this._at(j, h);
            if (P * D > 0) (B = j), (D = P), I === -1 && (_ *= 0.5), (I = -1);
            else {
              if (!(P * _ > 0)) break;
              (H = j), (_ = P), I === 1 && (D *= 0.5), (I = 1);
            }
          }
  ...
  (numeric.spline = function(t, n, r, i) {
    ...
    switch (typeof r) {
      case 'undefined':
        (o[0] = c(3 / (u[0] * u[0]), a[0])),
          p[0].push(0, 0),
          p[1].push(0, 1),
          p[2].push(2 / u[0], 1 / u[0]);
        break;
      case 'string':
        (o[0] = h(
          c(3 / (u[s - 2] * u[s - 2]), a[s - 2]),
          c(3 / (u[0] * u[0]), a[0])
        )),
          p[0].push(0, 0, 0),
          p[1].push(s - 2, 0, 1),
          p[2].push(1 / u[s - 2], 2 / u[s - 2] + 2 / u[0], 1 / u[0]);
        break;
      default:
    ...
    for (f = 1; f < s - 1; f++)
      (o[f] = h(
        c(3 / (u[f - 1] * u[f - 1]), a[f - 1]),
        c(3 / (u[f] * u[f]), a[f])
      )),
        p[0].push(f, f, f),
        p[1].push(f - 1, f, f + 1),
        p[2].push(1 / u[f - 1], 2 / u[f - 1] + 2 / u[f], 1 / u[f]);
    switch (typeof i) {
      case 'undefined':
        (o[s - 1] = c(3 / (u[s - 2] * u[s - 2]), a[s - 2])),
          p[0].push(s - 1, s - 1),
          p[1].push(s - 2, s - 1),
    ...
    if (typeof r == 'string')
      for (f = d.length - 1; f !== -1; --f)
        (d[f] = numeric.ccsLUPSolve(
          numeric.ccsLUP(numeric.ccsScatter(p)),
          o[f]
        )),
          (d[f][s - 1] = d[f][0]);
    else
    ...
    return (
      typeof n[0] == 'number' ? (d = d[0]) : (d = numeric.transpose(d)),
      new numeric.Spline(t, n, n, d, d)
    );
  }),
  ...
  (numeric.T.prototype.fft = function() {
    ...
    if (typeof n != 'undefined') for (h = 0; h < r; h++) m[h] = n[h];
    a[0] = 1;
    for (h = 1; h <= u / 2; h++)
      (d = p * h * h),
        (a[h] = l(d)),
    ...
    return (
      (y = y.mul(b)),
      numeric.convpow2(y.x, y.y, numeric.clone(b.x), numeric.neg(b.y)),
      (y = y.mul(b)),
      (y.x.length = r),
      (y.y.length = r),
      y
    ...
    for (o = 0; o < r; o++) {
      ...
      for (;;) {
        ...
        (l[o] = (a - f) / (2 * N)),
          ...
          (S = (a - i) / N),
          (x = (i - f) / N),
          (T = s(m(l[o]), m(i), m(a), m(f), m(y), m(b), m(w), 1e-8)),
  ...
  (numeric.uncmin = function(t, n, r, i, s, o, u) {
    ...
    typeof u == 'undefined' && (u = {}),
      typeof r == 'undefined' && (r = 1e-8),
      typeof i == 'undefined' &&
        (i = function(e) {
          return a(t, e);
        }),
      typeof s == 'undefined' && (s = 1e3),
      (n = numeric.clone(n));
    var f = n.length,
      l = t(n),
      c,
  ...
  (numeric.Dopri.prototype._at = function(t, n) {
    ...
    return (
      ...
      (h = l + y * g),
      (v = a[n]),
      (S = E(u[n], w(p, 1 / (l - h) + 2 / (l - c)))),
      (x = E(u[n + 1], w(d, 1 / (c - h) + 2 / (c - l)))),
      (T = [
        (r(t - c) * (t - h)) / r(l - c) / (l - h),
        (r(t - l) * r(t - c)) / r(l - h) / r(c - h),
        (r(t - l) * (t - h)) / r(c - l) / (c - h),
        ((t - l) * r(t - c) * (t - h)) / r(l - c) / (l - h),
        ((t - c) * r(t - l) * (t - h)) / r(l - c) / (c - h),
      ]),
      b(b(b(b(w(p, T[0]), w(v, T[1])), w(d, T[2])), w(S, T[3])), w(x, T[4]))
    );
  }),
  (numeric.Dopri.prototype.at = function(t) {
    ...
    var a = this.x;
    (n = 0), (r = a.length - 1);
    while (r - n > 1) (i = s(0.5 * (n + r))), a[i] <= t ? (n = i) : (r = i);
    return this._at(t, n);
  }),
  (numeric.dopri = function(t, n, r, i, s, o, u) {
    ...
    var a = [t],
      ...
      V,
      $,
      J = new numeric.Dopri(a, f, l, g, -1, '');
    typeof u == 'function' && (X = u(t, r));
    while (t < n && M < o) {
      ++M,
        t + O > n && (O = n - t),
        (c = i(t + N[0] * O, _(r, D(y * O, l[k])))),
        (h = i(t + N[1] * O, _(_(r, D(b[0] * O, l[k])), D(b[1] * O, c)))),
        (p = i(
          t + N[2] * O,
          _(_(_(r, D(w[0] * O, l[k])), D(w[1] * O, c)), D(w[2] * O, h))
        )),
        (d = i(
          t + N[3] * O,
          _(
            _(_(_(r, D(E[0] * O, l[k])), D(E[1] * O, c)), D(E[2] * O, h)),
            D(E[3] * O, p)
          )
        )),
        (v = i(
          ...
          _(
            _(
              _(_(_(r, D(S[0] * O, l[k])), D(S[1] * O, c)), D(S[2] * O, h)),
              D(S[3] * O, p)
            ),
            D(S[4] * O, d)
          )
        ...
        (P = _(
          _(
            _(_(_(r, D(l[k], O * x[0])), D(h, O * x[2])), D(p, O * x[3])),
            D(d, O * x[4])
          ),
          D(v, O * x[5])
        )),
        ...
        (L = _(
          _(
            _(
              _(_(D(l[k], O * C[0]), D(h, O * C[2])), D(p, O * C[3])),
              D(d, O * C[4])
            ),
            D(v, O * C[5])
          ),
      ...
      (g[k] = _(
        _(
          _(
            _(_(_(r, D(l[k], O * T[0])), D(h, O * T[2])), D(p, O * T[3])),
            D(d, O * T[4])
          ),
          D(v, O * T[5])
        ),
            ...
            if (typeof X == 'number')
              ...
              for (A = X.length - 1; A !== -1; --A)
                X[A] < 0 &&
                  ...
                  (Y = j(
                    Y,
                    (st * V[A] * Q - it * X[A] * G) / (st * V[A] - it * X[A])
                  ));
            }
            if (Y <= Q || Y >= G) break;
            (K = J._at(Y, k - 1)),
      ...
      (t += O), (r = P), (X = V), (O = j(0.8 * O * q(s / H, 0.25), 4 * O));
    }
  ...
  (numeric.__solveLP = function(t, n, r, i, s, o, u) {
    ...
    for (U = w; U < s; ++U) {
      ...
      if (!P(H(R, 0))) return { solution: o, message: '', iterations: U };
      o = g;
      if (E < i) return { solution: g, message: '', iterations: U };
      if (u) {
        var Y = h(t, W),
          Z = h(n, W);
        y = !0;
      ...
      if (y) return { solution: g, message: 'Unbounded', iterations: U };
    }
    return {
      solution: o,
  ...
  (numeric._solveLP = function(t, n, r, i, s) {
    var o = t.length,
      ...
      a = numeric
        .rep([o], 0)
        .concat(Math.max(0, numeric.sup(numeric.neg(r))) + 1),
      w = numeric.__solveLP(m, y, b, i, s, a, !1),
      E = numeric.clone(w.solution);
    E.length = o;
    var S = numeric.inf(h(r, p(n, E)));
    if (S < 0)
      return { solution: NaN, message: 'Infeasible', iterations: w.iterations };
  ...
  (numeric.solveLP = function(t, n, r, i, s, o, u) {
    typeof u == 'undefined' && (u = 1e3),
      typeof o == 'undefined' && (o = numeric.epsilon);
    ...
    for (s = 0; s < i; ++s) {
      ...
      switch (n) {
        ...
        case 2:
          ...
          break;
        case 3:
          h.hasOwnProperty(w[0]) ||
            ((h[w[0]] = p), (v[p] = 0), (m[p] = numeric.rep([c], 0)), ++p);
          var E = h[w[0]];
  ...
  (function(e) {
    ...
    function o(e, t, n, o, u, a, f, l, c, h, p, d, v, m, g, y) {
      ...
      function $() {
        ...
        if (v === o) g[E] = g[o];
          ...
          for (b = o; b >= v + 1; b -= 1) {
            if (g[b] === 0) break;
            (j = Math.max(Math.abs(g[b - 1]), Math.abs(g[b]))),
              (F = Math.min(Math.abs(g[b - 1]), Math.abs(g[b]))),
              g[b - 1] >= 0
                ? (D = Math.abs(j * Math.sqrt(1 + (F * F) / (j * j))))
                : (D = -Math.abs(j * Math.sqrt(1 + (F * F) / (j * j)))),
              (j = g[b - 1] / D),
              (F = g[b] / D);
            if (j === 1) break;
      ...
      function J() {
        (E = k + (T * (T + 1)) / 2 + 1), (S = E + T);
        if (g[S] === 0) return 798;
        (j = Math.max(Math.abs(g[S - 1]), Math.abs(g[S]))),
          (F = Math.min(Math.abs(g[S - 1]), Math.abs(g[S]))),
          g[S - 1] >= 0
            ? (D = Math.abs(j * Math.sqrt(1 + (F * F) / (j * j))))
            : (D = -Math.abs(j * Math.sqrt(1 + (F * F) / (j * j)))),
          (j = g[S - 1] / D),
    ...
    function u(e, r, i, s, u, a) {
      ...
      return (
        o(e, r, l, l, m, d, i, s, l, c, u, v, h, y, g, a),
        (b = ''),
        a[1] === 1 && (b = 'constraints are inconsistent, no solution!'),
        a[1] === 2 &&
          (b = 'matrix D in quadratic function is not positive definite!'),
        {
          solution: n(m),
          value: n(d),
    ...
    for (f = p - 1; f != -1; f += -1)
      for (var N = 0; N < s; N++) {
        ...
        (E = v[l]),
          ...
          (b = d[f - 1]),
          (w = d[f]),
          (y = ((S - x) * (S + x) + (b - w) * (b + w)) / (2 * w * S)),
          (b = g(y, 1)),
          y < 0
            ? (y = ((E - x) * (E + x) + w * (S / (y - b) - w)) / E)
            : (y = ((E - x) * (E + x) + w * (S / (y + b) - w)) / E),
          (o = 1),
          (T = 1);
        for (u = l + 1; u < f + 1; u++) {
